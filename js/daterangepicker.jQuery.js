...
jQuery.fn.daterangepicker = function(settings){
	...
	var options = jQuery.extend({
		presetRanges: [
			...
			{text: 'Ultimos 7 días', dateStart: 'today-7days', dateEnd: 'today' },
			{text: 'Ultimos 15 días', dateStart: 'today-15days', dateEnd: 'today' },
			...
			{text: 'Mañana', dateStart: 'Tomorrow', dateEnd: 'Tomorrow' },
			//{text: 'Ad Campaign', dateStart: '03/07/08', dateEnd: 'Today' },
			{text: 'Ultimos 30 días', dateStart: 'Today-30', dateEnd: 'Today' },
			{text: 'Siguientes 30 días', dateStart: 'Today', dateEnd: 'Today+30' },
		...
		presets: {
			...
			//allDatesAfter: 'Todos los días despues de', 
			dateRange: 'Rango de fechas'
		},
		rangeStartTitle: 'Fecha de inicio',
		rangeEndTitle: 'Fecha de fin',
