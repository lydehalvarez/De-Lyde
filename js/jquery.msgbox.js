  ...
  $.extend({
    MsgBoxObject: {
      ...
      create: function() {
		...
		this.esqueleto.form = $('<div id="sustform"></div>');
...
//          }
          ...
          if (options.type != 'prompt')
          {
            $.each(buttons, $.proxy(function(i, button) {
              ...
              {
                this.esqueleto.buttons.append($('<button type="button">'+button.value+'</button>').bind('click', $.proxy(function(e) { this.close(button.value);  }, this)));
              }
          ...
          else if (options.type == 'prompt')
          {
            $.each(buttons, $.proxy(function(i, button) {
              ...
              {
                this.esqueleto.buttons.append($('<button type="cancel">'+button.value+'</button>').bind('click', $.proxy(function(e) { this.close(false); e.preventDefault(); }, this)));
              };
            }, this));
          };
