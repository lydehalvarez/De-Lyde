    ...
    var timeAgo = function(dateString) {
      ...
      if (diff < hour) {
        //return Math.floor(diff / minute) + " minutes ago";
		 return " hace " + Math.floor(diff / second) + " minutos "
      }
    ...
    TWTR.Widget.prototype = function() {
      ...
      return {
        init: function(opts) {
          ...
          if (opts.version >= 2 && !TWTR.Widget.hasLoadedStyleSheet) {
            if (isHttps) {
			  ...
			  twttr.loadStyleSheet('/css/TwitterWidget.css', this.widgetEl);
        ...
        setFooterText: function(s) {
          this.footerText = (is.def(s) && is.string(s)) ? s : 'Unete a la conversaci&oacute;n';
          if (this._rendered) {
