...
jQuery(function($) {
	...
	var isIE6 = (jQuery.browser.msie && parseInt(jQuery.browser.version.substr(0,1)) < 8);
	var isIE7 = (jQuery.browser.msie && parseInt(jQuery.browser.version.substr(0,1)) > 6);
	var body = $('body');
	...
	function showContent(elts, settings, callback) {
		elts.contentWrapper
			.css({
				marginTop: (-60/2 + settings.marginScrollTop)+'px',
				marginLeft: (-60/2 + settings.marginScrollLeft)+'px',
				height: '60px',
				width: '60px',
				opacity: 0
			})
