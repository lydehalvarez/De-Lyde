...
$.fn.sliderNav = function(options) {
	var defaults = { debug: false, height: null, arrows: true};
	...
	var height = 400 //$('.slider-nav', slider).height();
	if(o.height) height = o.height;
	$('.slider-content', slider).css('height',height);
	$('.slider-nav', slider).css('height',height + 12);
	$('.slider-nav', slider).css('width',25);
