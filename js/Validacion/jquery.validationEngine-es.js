    ...
    $.validationEngineLanguage = {
        newLang: function(){
            $.validationEngineLanguage.allRules = {
                ...
                "RFC": {
                	"regex": /^[A-Z]{3,4}[ |\-]{0,1}[0-9]{6}[ |\-]{0,1}[0-9A-Z]{3}$/,
                    "alertText": "* No es un RFC válido,por favor escriba sólo en mayúsculas"
                },
                "CURP": {
                    ...
                    "alertText": "* No es una CURP válida,por favor escriba sólo en mayúsculas"
                },							
                "ipv4": {
