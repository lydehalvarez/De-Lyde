                ...
                <div class="col-sm-12 m-b-xs">
                    <div class="row">
                        ...
                        <label class="col-sm-2 control-label">Estatus:</label>
 					    <div class="col-sm-4 m-b-xs">
	<%  
                                var sEventos = "class='form-control ombman' style='width:200px'"
                                ComboSeccion("Estatus", sEventos, 52, -1, 0, "--Seleccionar--", "", "Editar")
                            %>                        </div>                            
                    
                        <label class="col-sm-2 control-label">ASN:</label>
                        <div class="col-sm-4 m-b-xs">
                            <input id="ASN" class="input-sm form-control" type="text" value="" style="width:150px">
                        </div>
                        </div>
                    </div>    
                </div>
                ...
                <div class="col-sm-12 m-b-xs">
                    <div class="row">
                        ...
                        <label class="col-sm-2 control-label">SKU:</label>
 					    <div class="col-sm-4 m-b-xs">
                            <input id="SKU" class="input-sm form-control" type="text" value="" style="width:150px">
                        </div>                            
                    
                        <label class="col-sm-2 control-label">Cita:</label>
                        <div class="col-sm-4 m-b-xs">
                            <input id="Cita" class="input-sm form-control" type="text" value="" style="width:150px">
                        </div>
                        </div>
                    </div>    
                </div>
...
<source type="audio/mp3" src="/pz/wms/Cliente/Audio/alarma.mp3">
</audio>-->
    <!-- Mainly scripts -->
...
//    });    
    ...
    CargaGridInicial()
      ...
      $("#btnBuscar").click(function(event) {
            ...
            dato['Estatus'] = $('#Estatus').val()
            dato['ASN'] = $('#ASN').val()
            dato['SKU'] = $('#SKU').val()
            dato['Cita'] = $('#Cita').val()

            $("#dvTablaClientes").load("/pz/wms/Cliente/B_DocClienteOC_Grid.asp",dato);
...
//			audio.play();
    ...
    function CargaGridInicial(){
        ...
        $("#dvTablaClientes").load("/pz/wms/Cliente/B_DocClienteOC_Grid.asp");

    }
     var OCFunciones = {

		CargaOC:function(cliid, cliocid){
            
            $("#CliOC_ID").val(cliocid)
			 $("#Cli_ID").val(cliid)
