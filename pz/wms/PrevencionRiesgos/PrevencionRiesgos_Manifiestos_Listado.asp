     ...
     <div class="ibox">
        <div class="ibox-title">
            ...
            <div class="ibox-tools">
                ...
                <label class="pull-right form-group">
                    <span class="text-success" id="lblPreRieManLisTot">
        ...
        <div class="ibox-content">
            <table class="table table-hover">
                <tbody id="tbPreRieManLis">
<%
while(!(rsMan.EOF)){
%> 
                    <tr class="cssTrPreRieManLisReg">
                        <td>
                            <%= rsMan("ID").Value %>
                        </td>
                        ...
                        <td class="project-title">
                            ...
                            <a>
                             ...
                             <br>
                            <a>
                                <i class="fa fa-money"></i> $<%= formato_numero(rsMan("Man_Total_Precio").Value, 2) %>
                            </a>
                        </td>
                        <td class="project-title">
                            <a title="Estado">
...
%>
                ...
                <tfoot>
                    <tr>
                        <td id="tfPreRieManLisCar" colspan="9">
