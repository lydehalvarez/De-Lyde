...
//        sSQL += " , ISNULL((SELECT Nombre FROM dbo.tuf_Usuario_Informacion(ASN_UsuarioNotifico)),'Sin informacion') Usuario "
//        sSQL += " , ISNULL(CONVERT(NVARCHAR(10),ASN_UsuarioNotificoFecha,103)+' - '+CONVERT(NVARCHAR(10),ASN_UsuarioNotificoFecha,108) ,'') FechaDoc "
...
<%/*%>            <br />
            <b>Usuario: </b><span><%=Parametro("Usuario","")%></span>
            <b>Fecha registro: </b><span><%=Parametro("FechaDoc","")%></span>
<%*/%>        </td>
