			...
			<div class="ibox">
				...
				<div class="ibox-content">
					<div class="table-responsive">
									...
									<td width="87%" class="desc"><table width="100%" class="table shoping-cart-table">
									  <tbody>
									    <tr>
									      <td  colspan="2" class="desc"><h3><a class="text-navy" href="#">Al iniciar </a></h3>
									        Validaci&oacute;n que se ejecuta al iniciar este paso del proceso. </td>
								        </tr>
									    <tr>
									    ...
									    <tr>
									      ...
									      <td class="desc"><input type="text" class="objTxt" style="width:100%" value="<%=Parametro("ProF_Val_Al_Iniciar","")%>" id="ProF_Fn_Al_Iniciar" /></td>
								        </tr>
									    <tr>
									      <td class="desc">&nbsp;</td>
									      <td class="desc">&nbsp;</td>
			...
			<div class="ibox-content">
					<div class="table-responsive">
					  <table width="100%" class="table shoping-cart-table">
					    <tbody>
					      <tr>
					        <td colspan="2" class="desc"><h3><a class="text-navy" href="#">Al terminar </a></h3>
					          Validac&oacute;n que se ejecuta al terminar este paso del proceso. </td>
				          </tr>
					      <tr>
					        <td width="19%" class="desc">&nbsp;</td>
					        <td width="81%" class="desc">&nbsp;</td>
					      ...
					      <tr>
					        <td class="desc">Nombre de la funci&oacute;n</td>
					        <td class="desc"><input type="text" class="objTxt" style="width:100%" value="<%=Parametro("ProF_Val_Al_Terminar","")%>" id="ProF_Fn_Al_Terminar" /></td>
				          </tr>
					      <tr>
					        <td class="desc">&nbsp;</td>
					        <td class="desc">&nbsp;</td>
			...
			<div class="ibox-content">
					<div class="table-responsive">
					  <table width="100%" class="table shoping-cart-table">
					    <tbody>
					      <tr>
					        <td width="87%" class="desc"><h3><a class="text-navy" href="#">Al cambio de estatus </a></h3>
					          <p>Validaci&oacute;n que se ejecutar&aacute; cuando un estatus cambie.</p>
					          <dl class="m-b-none">
					            <%                   
	 
var sSQL  = "SELECT p.ProE_ID, ProE_Nombre, ProE_Descripcion, ProE_Validacion " 	
...
%>
					            <dd>
					              <div class="row stEstatus">
					                <div class="estEtq"> <%=rsEstatus.Fields.Item("ProE_Nombre").Value%>&nbsp;&nbsp;</div>
					                <div class="esttexto">
					                  <input type="text" class="objEsttTxt" style="width:100%" 
                             value="<%=rsEstatus.Fields.Item("ProE_Validacion").Value%>" 
