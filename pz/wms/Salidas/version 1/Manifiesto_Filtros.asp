            ...
            <div class="row">
                <div class="col-sm-12 m-b-xs">
                    <div class="row">
                        ...
                        <div class="col-sm-4 m-b-xs" >
  							<input type="checkbox"  id = "ckb1" value="Transferencias" class="i-checks ChkRel" onclick="javascript:CargaManif(1)"> </input> 
                        ...
                        <label >Transferencias</label>
                         ...
                         <div class="col-sm-4 m-b-xs" >
  							<input type="checkbox" id = "ckb2" value="OV" class="i-checks ChkRel" onclick="javascript:CargaManif(2)">   </input>
  					
 								 <label >Ordenes de venta</label>
                   		     </div>
            ...
            <div class="row">
                <div class="col-sm-12 m-b-xs">
                    <div class="row">
                        ...
                        <div class="col-sm-4 m-b-xs" >
  							<input type="checkbox"  id = "ckb1" value="Pendientes" class="i-checks ChkRel" onclick="javascript:CargaManif(3)"> </input> 
                        ...
                        <label >Transferencias</label>
                         ...
                         <div class="col-sm-4 m-b-xs" >
  							<input type="checkbox" id = "ckb2" value="Historico" class="i-checks ChkRel" onclick="javascript:CargaManif(4)">   </input>
...
$(document).ready(function(){
    ...
    CargaGridInicial()
      ...
      $("#btnBuscar").click(function(event) {
            ...
            $("#dvTabla").load("/pz/wms/Salidas/Manifiestos.asp",dato);
	   }); 
});    
    
    function CargaGridInicial(){

        $("#dvTabla").load("/pz/wms/Salidas/Manifiestos.asp");
    ...
    success: function (data) {
			...
			Avisa(Tipo,"Aviso",response.message);
			 ...
			 function CargaManif(Tipo){
		 		var sDatos = "Tipo=" + Tipo 
			   sDatos += "&Serie=" + $("#SerieOculta").val();	

	if(Tipo==1){
			$("#dvTabla").show()
			$("#dvTabla").load("/pz/wms/Salidas/Manifiestos.asp?" + sDatos
			 , function(data){
			$("#input_Serie").val("")
			if($("#TAOculta").val() == 0){
			sTipo = "error";
			sMensaje = "No hay manifiestos con transferencia";
		...
		if(Tipo==2){
			...
			if($("#OVOculta").val() == 0){
			sTipo = "error";
			sMensaje = "No hay manifiestos con orden de venta";
			Avisa(sTipo,"Aviso",sMensaje);
			$("#dvTabla").hide()
					}
});
