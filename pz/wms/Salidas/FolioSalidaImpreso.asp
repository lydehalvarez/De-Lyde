...
<%
	...
	sSQL = "UPDATE Manifiesto_Salida SET Man_ValidacionConcluida = 1, Man_FechaValidacion = getdate() WHERE Man_ID = "+Man_ID 
		 Response.Write(sSQL)
		Ejecuta(sSQL,0)
	   rsTras.MoveNext() 
            	}
...
sSQL =" SELECT m.*, p.Prov_Nombre , getdate() as fecha FROM Manifiesto_Salida m"
		...
		//Response.Write(sSQL)
			  ...
			  var Fecha = rsManifiesto.Fields.Item("Man_FechaValidacion").Value 
...
<body>
 ...
 <table width="646" height="192" border="1" style="text-align:center;">
