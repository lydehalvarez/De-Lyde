      ...
      <div class="col-lg-12">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-title" id="dvFiltros" >
             ...
             <h5>Filtros de b&uacute;squeda: Transferencias en shipping</h5>
            </div>
                ...
                <div class="row"> 
                    <div class="col-sm-12 m-b-xs">        
                     <label class="col-sm-2 control-label">Tipo de Ruta:</label>
                        <div class="col-sm-4 m-b-xs">
							<%  
                                var sEventos = "class='form-control ombman'"
            ...
            <div class="row">
                <div class="col-sm-12 m-b-xs">
                    ...
                    placeholder="Escanea el folio de la transferencia" type="text" autocomplete="off" value="" />
            ...
            <div class="form-horizontal">
                ...
                <div class="form-group">
                     ...
                     <div class="col-md-3">
                        ...
                        CargaCombo("Cat_ID","class='form-control'","Cat_ID",campo,"Cat_Catalogo",condicion,"","Editar",0,"Selecciona")%>
                     </div>
                  ...
                  <label class="control-label col-md-3"><strong>Estado</strong></label>
                    <div class="col-md-3">
                        <%
                            ...
                            CargaCombo("Edo_ID","class='form-control '","Edo_ID",campo,"Cat_Estado",condicion,"","Editar",0,"Selecciona")%>
                   </div>
                   <label class="control-label col-md-3"><strong>Aeropuerto</strong></label>
                    ...
                    <%
                            ...
                            var condicion = ""
                            CargaCombo("Aer_ID","class='form-control'","Aer_ID",campo,"Cat_Aeropuerto",condicion,"","Editar",0,"Selecciona")
                    ...
                    <div class="form-group">
                          <label class="control-label col-md-3"><strong>Ruta</strong></label>
                            <div class="col-md-3">
                                ...
                                CargaCombo("Man_Ruta","class='form-control'","Alm_Ruta",campo,"Almacen",condicion,"","Editar",0,"Selecciona")%>
                            </div>
                    </div>
                </div>	
            </div>   
...
var ManifiestoFunciones = {
		EditaManifiesto:function(folcli,vehiculo,conductor,placas,provid,tpruta,aerid,ruta,edoid)	{
				$('#modalManifiesto').modal('show') 
				if(folcli==0){
				folcli=""	
				}
