  ...
  <table class="table table-hover">
    <tbody>
		...
		Fecha = rsManifiesto.Fields.Item("Fecha").Value
		  ...
		  sSQL = "SELECT * FROM Proveedor_Guia g"
  		 ...
  		 var rsGuia = AbreTabla(sSQL,1,0)
		 		  	  sSQL = "SELECT * FROM Manifiesto_Salida_GPS g WHERE Man_ID =" + rsManifiesto.Fields.Item("Man_ID").Value
      ...
      <tr id="Man_<%=Man_ID%>">
        ...
        <td valign="top" class="project-title" id="ManGPS_<%=Man_ID%>">
            <a href="#">GPS:</a>
			...
			%>
             ...
             <br />
             <br />
           		 <a class="btn btn-white btn-sm"  href="#" onclick="ManifiestoFunciones.GPS(<%=Man_ID%>);  return false">
              <i class="fa fa-plus"></i> GPS </a>
