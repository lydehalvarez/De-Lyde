    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="form-horizontal">
                                 ...
                                 <input type = "hidden" class = "form-control agenda" type="text" value="<%=TA_ID%>" id="TA_ID"/>
                               <input type = "hidden"  class = "form-control agenda" type="text" value="<%=Cli_ID%>"   id="Cli_ID"/>
