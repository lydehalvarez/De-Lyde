...
<div class="ibox float-e-margins">
	<div class="ibox-title">
    	<span class="label label-primary pull-right"><%=Estatus %></span>
        <h5><%=Titulo %></h5>
    </div>
    	...
    	<div class="row">
        	<div class="col-md-6">
            	<h1 class="no-margins"><%=Dato %></h1>
             	<div class="font-bold text-navy"><%=Porcentaje %> <i class="fa fa-level-up"></i> <small><%=SubTitulo %></small></div>
          	</div>
        <div class="col-md-6">
        	<h1 class="no-margins"><%=Dato %></h1>
            <div class="font-bold text-navy"><%=Porcentaje %> 
            	<i class="fa fa-level-up"></i>
                <small><%= SubTitulo%></small></div
            ></div>
        </div>
   </div>
</div></div>
