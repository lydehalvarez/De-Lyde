...
%>
	<ul class="stat-list m-t-lg">
    	<li>
        	<h2 class="no-margins"><%Response.Write("124")%></h2>
        	<small><%Response.Write("Total de ordenes en el ultimo periodo")%></small>
        	<div class="progress progress-mini">
            	<div class="progress-bar" style="width:<%Response.Write("40%")%>;"></div>
         	</div>
      	</li>
     	<li>
        	<h2 class="no-margins "><%Response.Write("203")%></h2>
         	<small><%Response.Write("Ordenes en el ultimo mes")%></small>
         	<div class="progress progress-mini">
            	<div class="progress-bar" style="width:<%Response.Write("60%")%>;"></div>
         	</div>
      	</li>
	</ul>
