...
<%
   ...
   var SubTitulo = ""    
	...
	if (!rsEtq.EOF)
	{	 
		 DsbC_Query += rsEtq.Fields.Item("DsbC_Query").Value 
	}
    rsEtq.Close()      
...
<div class="ibox float-e-margins">
	<div class="ibox-title">
    	<span class="label label-primary pull-right"><%Response.Write("Hoy")%></span>
        <h5><%=Dato%></h5>
    </div>
    <div class="ibox-content">
    	<div class="row">
       		<div class="col-md-6">
            	<h1 class="no-margins"><%Response.Write("328")%></h1>
               	<div class="font-bold text-navy"><%Response.Write("60%")%><i class="fa fa-level-up"></i> <small><%Response.Write("Sims")%></small></div>
        	</div>
            <div class="col-md-6">
               <h1 class="no-margins"><%Response.Write("164")%></h1>
               <div class="font-bold text-navy"><%Response.Write("40%")%> <i class="fa fa-level-up"></i> <small><%Response.Write("Telefonos")%></small></div>
            </div>
        </div>
      </div>
   </div>
