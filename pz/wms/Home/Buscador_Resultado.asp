...
var TipoBuscador = 0
    ...
    // Buscador principal
    // busquedas directas que reenvian a una ventana especial del tema
    //  cuando comienza con TRA SO REM Guia FC
    //  si no se hara una busqueda en todo y se pone en una mascara de respuesta con opcion a brincar a otro lado
