                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-content mailbox-content">
                        <div class="file-manager">
                            <a class="btn btn-block btn-primary compose-mail" href="#">Nuevo mensaje</a>
                            <div class="space-25"></div>
                            <h5>Temas</h5>
                            <ul class="folder-list m-b-md" style="padding: 0">
                                <li><a href="mailbox.html"> <i class="fa fa-inbox "></i> Servicios <span class="label label-warning pull-right">16</span> </a></li>
                                <li><a href="mailbox.html"> <i class="fa fa-envelope-o"></i> Mensajes</a></li>
                                <li><a href="mailbox.html"> <i class="fa fa-certificate"></i> Importante</a></li>
                                <li><a href="mailbox.html"> <i class="fa fa-file-text-o"></i> Transporte <span class="label label-danger pull-right">2</span></a></li>
                                <li><a href="mailbox.html"> <i class="fa fa-file-text-o"></i> RRHH</a></li>
                                <li><a href="mailbox.html"> <i class="fa fa-file-text-o"></i> Clientes</a></li>
                                <li><a href="mailbox.html"> <i class="fa fa-file-text-o"></i> Facturaci&oacute;n</a></li>
                            </ul>
                            <h5>Categorias</h5>
                            <ul class="category-list" style="padding: 0">
                                <li><a href="#"> <i class="fa fa-circle text-navy"></i> Nuevo </a></li>
                                <li><a href="#"> <i class="fa fa-circle text-danger"></i> Terminado</a></li>
                                <li><a href="#"> <i class="fa fa-circle text-primary"></i> Trabajandose</a></li>
                                <li><a href="#"> <i class="fa fa-circle text-info"></i> Facturaci&oacute;n</a></li>
                                <li><a href="#"> <i class="fa fa-circle text-warning"></i> Error</a></li>
                            </ul>

                            <h5 class="tag-title">Etiquetas</h5>
                            <ul class="tag-list" style="padding: 0">
                                <li><a href=""><i class="fa fa-tag"></i> Servicio</a></li>
                                <li><a href=""><i class="fa fa-tag"></i> Falta</a></li>
                                <li><a href=""><i class="fa fa-tag"></i> Pendiente</a></li>
                                <li><a href=""><i class="fa fa-tag"></i> Emergencia</a></li>
                                <li><a href=""><i class="fa fa-tag"></i> Atenci&oacute;n</a></li>
                                <li><a href=""><i class="fa fa-tag"></i> Iniciado</a></li>
                                <li><a href=""><i class="fa fa-tag"></i> Urgente</a></li>
                                <li><a href=""><i class="fa fa-tag"></i> Revisar</a></li>
                            </ul>
