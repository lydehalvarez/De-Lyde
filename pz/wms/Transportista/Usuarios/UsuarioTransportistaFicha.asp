...
$(document).ready(function() {  
    ...
    $("#btnGuardarEdicion").click(function (){
      ...
      //console.log($("#Usu_Email").val());
        ...
        $.post("/pz/wms/Transportista/Usuarios/UsuarioTransportistaFicha_Ajax.asp",{
    ...
    function CargaFichaConsulta(ijqAcc) {
      ...
      var sData  ="Prov_ID="+$("#Prov_ID").val()
          ...
          sData += "&Acc="+ijqAcc;
          //console.log(sData);
          $("#divConsulta").load("/pz/wms/Transportista/Usuarios/UsuarioTransportistaFichaConsulta.asp?"+sData);	
          //$("#divEditar").hide("slow");
