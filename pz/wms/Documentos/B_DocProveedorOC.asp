...
<% 
    ...
    CargaCombo("cbProv_ID", sEventos, "Prov_ID", "Prov_Nombre", "Proveedor", "", "Prov_Nombre"
              , Parametro("Prov_ID",-1), 0, "No aplica", "Editar")
%>
                        </div>
                ...
                <div class="col-sm-12 m-b-xs">
                    <div class="row">
                        ...
                        <div class="col-sm-4 m-b-xs" >
                          ...
                          <label class="col-sm-2 control-label">Folio proveedor:</label>
                        <div class="col-sm-4 m-b-xs">
                            <input id="OC_FolioProveedor" class="input-sm form-control" type="text" value="" style="width:150px">
                        </div>
                    </div>    
                </div>
            </div>
            ...
            <div class="table-responsive" id="dvTablaProveedor"></div>  
          </div>
        </div>
      </div>
    </div>
...
//    });    
    ...
    CargaGridInicial()
      ...
      $("#btnBuscar").click(function(event) {
            ...
            dato['Prov_ID'] = $('#cbProv_ID').val()
            dato['OC_Folio'] = $('#OC_Folio').val()
            dato['OC_FolioProveedor'] = $('#OC_FolioProveedor').val()
            dato['FechaInicio'] = $('#inicio').val()
            dato['FechaFin'] = $('#fin').val()

            $("#dvTablaProveedor").load("/pz/wms/Documentos/B_DocProveedorOC_Grid.asp",dato);
    ...
    function CargaGridInicial(){
        ...
        $("#dvTablaProveedor").load("/pz/wms/Documentos/B_DocProveedorOC_Grid.asp");
