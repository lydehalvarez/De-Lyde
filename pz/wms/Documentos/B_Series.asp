...
%>
                        ...
                        <label class="col-sm-2 control-label">N&uacute;mero de serie:</label>    
                        <div class="col-sm-3 m-b-xs">
                            <input id="Serie" class="input-sm form-control" type="text" value="" style="width:150px">
                        </div>
            ...
            <div class="form-group">
                ...
                <label class="checkbox-inline i-checks"> <input type="checkbox" value="1"> Transferencias</label>
                </div>
                <div class="col-sm-2 m-b-xs">
                <label class="checkbox-inline i-checks"> <input type="checkbox" value="2"> Ordenes de venta </label>
                </div>
                <div class="col-sm-2 m-b-xs">
                <label class="checkbox-inline i-checks"> <input type="checkbox" value="3"> Ingresos </label>
                </div>
            ...
            <div class="table-responsive" id="dvResultadoSeries"></div>  
          </div>
        </div>
      </div>
    </div>
...
$(document).ready(function(){
    ...
    CargaGridInicial()
      ...
      $("#btnBuscar").click(function(event) {
            ...
            $("#dvResultadoSeries").load("/pz/wms/Documentos/B_SeriesConsulta.asp",dato);
    ...
    function CargaGridInicial(){
        ...
        $("#dvResultadoSeries").load("/pz/wms/Documentos/B_SeriesConsulta.asp");
