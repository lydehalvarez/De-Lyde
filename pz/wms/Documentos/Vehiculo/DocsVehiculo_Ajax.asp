	...
	switch (parseInt(Tarea)) {
		...
		case 1:  //Guardando documento
			try {
				...
				var sSQLACT =  " INSERT INTO Vehiculo_Documentos (Veh_ID, Doc_ID, Docs_ID "
					sSQLACT += ", Docs_Nombre, Docs_RutaArchivo, Docs_Titulo, Docs_Observaciones) " 
					sSQLACT += " VALUES (" + Veh_ID + "," + Doc_ID + "," + Docs_ID 
		...
		case 2:  //Borrando documento de la bd
			try {
				...
				var sSQLACT =  " DELETE FROM Vehiculo_Documentos "	
	                sSQLACT += " WHERE Veh_ID = " + Veh_ID
		...
		case 3:  //Buscando el siguiente ID
			try {	
			 	...
			 	var sCondicion = " Veh_ID = " + Veh_ID
					sCondicion += " AND Doc_ID = " + Doc_ID
					//sCondicion += " AND Docs_ID = " + Docs_ID
				sResultado = SiguienteID("Docs_ID","Vehiculo_Documentos",sCondicion,0)
		...
		case 4:  //Borrando documento de la bd
			try {
				...
				var sSQLACT =  " UPDATE Vehiculo_Documentos "	
