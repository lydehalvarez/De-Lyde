...
<% if(NombreXML != "") {%>
	...
	var url = "/Media/agt/Vehiculo/<%=NombreXML%>";
...
function DocGuardar(){
	$.post("/pz/agt/Documentos/Vehiculo/DocsVehiculo_Ajax.asp"
	  , { Tarea:5,Veh_ID:$("#Veh_ID").val(),Doc_ID:$("#Doc_ID").val(),Docs_ID:$("#Docs_ID").val() 
