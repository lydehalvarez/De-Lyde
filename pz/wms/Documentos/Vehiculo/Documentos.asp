...
//	var Deu_ID = Parametro("Deu_ID",-1)	
  ...
  var iRegistros = 0
	...
	var NivelVentana = ParametroDeVentana(SistemaActual, VentanaIndex, "Nivel de documentos a mostrar", 0)	
	    //1 = documentos de Servicios
		//2 = documentos de
		//3 = documentos de Vehiculos
		//4 = documentos de  	
...
if (NivelVentana == 1 ) {
	...
	ArchivoJS = "/pz/cop/Documentos/DocumentosServicio.js"
	PK = "Ser_ID"
	PKValor = Ser_ID
	
var sSQLDocs  = " SELECT DOC.Doc_ID, DOC.Doc_Nombre, ISNULL(Tb2.Ser_ID,-1) AS Ser_ID  "
	...
	sSQLDocs += " LEFT OUTER JOIN Servicio_Documentos Tb2 "
	sSQLDocs += " ON DOC.Doc_ID = Tb2.Doc_ID "
	sSQLDocs += " AND Tb2.Ser_ID = " + Ser_ID
	...
	if (ServicioForaneo == 0) {
		sSQLDocs += " AND DOC.Doc_NivelServicio = 1 "
	} else if(ServicioForaneo == 1) {
		sSQLDocs += " AND DOC.Doc_NivelServicioForaneo = 1 "
	}
...
if (NivelVentana == 2 ) {	
	...
	ArchivoJS = "/pz/cop/Documentos/Cliente/DocumentosCliente.js"
	PK = "Cli_ID"
	PKValor = Cli_ID
...
if (NivelVentana == 3 ) {
	...
	ArchivoJS = "/pz/agt/Documentos/Vehiculo/DocumentosVehiculo.js"
	PK = "Veh_ID"
	PKValor = Veh_ID
	
var sSQLDocs  = " SELECT DOC.Doc_ID, DOC.Doc_Nombre, ISNULL(Tb2.Veh_ID,-1) AS Veh_ID"
	sSQLDocs += " ,ISNULL(Tb2.Docs_ID,-1) AS Docs_ID "
	sSQLDocs += " ,Docs_Validado"
	...
	sSQLDocs += " FROM Cat_Documento DOC "
	sSQLDocs += " LEFT OUTER JOIN Vehiculo_Documentos Tb2 "
	sSQLDocs += " ON DOC.Doc_ID = Tb2.Doc_ID "
	sSQLDocs += " AND Tb2.Veh_ID = " + Veh_ID
	sSQLDocs += " WHERE  DOC.Doc_Habilitado = 1 "
	if (Doc_EsParaEmitir < 2) {   //0 = no, 1 = si, 2 = ambos
		sSQLDocs += " AND DOC.Doc_EsParaEmitir = " + Doc_EsParaEmitir 
	}
	sSQLDocs += " AND Doc_NivelVehiculo = 1 "
	sSQLDocs += " ORDER BY DOC.Doc_Orden "
...
/*if (NivelVentana == 4 ) {
	...
	ArchivoJS = "/pz/agt/Documentos/DocumentosCompradores.js"
	PK = "Com_ID"
	PKValor = Com_ID
	
var sSQLDocs  = " SELECT DOC.Doc_ID, DOC.Doc_Nombre, ISNULL(Tb2.Com_ID,-1) AS Com_ID"
	sSQLDocs += " ,ISNULL(Tb2.Docs_ID,-1) AS Docs_ID "
	sSQLDocs += " ,Docs_Validado"
	sSQLDocs += " ,Tb2.Docs_Nombre, Tb2.Docs_Titulo, Tb2.Docs_RutaArchivo , Tb2.Docs_FechaRegistro "
	sSQLDocs += " , ISNULL((CONVERT(NVARCHAR(20),Tb2.Docs_FechaRegistro, 103)),'') as FechaRegistro "
	sSQLDocs += " , (CASE ISNULL(Tb2.Docs_FechaRegistro,-1) WHEN -1 THEN 0 ELSE 1 END) AS Cargado "
	sSQLDocs += " FROM Cat_Documento DOC "
	sSQLDocs += " LEFT OUTER JOIN Comprador_Documentos Tb2 "
	sSQLDocs += " ON DOC.Doc_ID = Tb2.Doc_ID "
	sSQLDocs += " AND Tb2.Com_ID = " + Com_ID
	sSQLDocs += " WHERE  DOC.Doc_Habilitado = 1 "
	if (Doc_EsParaEmitir < 2) {   //0 = no, 1 = si, 2 = ambos
		sSQLDocs += " AND DOC.Doc_EsParaEmitir = " + Doc_EsParaEmitir 
	}
	sSQLDocs += " AND DOC.Doc_NivelComprador = 1 "
	sSQLDocs += " ORDER BY DOC.Doc_Orden "	
...
if (NivelVentana == 4 ) {
	...
	ArchivoJS = "/pz/cop/Documentos/DocumentosEmpleado.js"
	PK = "Emp_ID"
	PKValor = Emp_ID
	
var sSQLDocs  = " SELECT DOC.Doc_ID, DOC.Doc_Nombre, ISNULL(Tb2.Emp_ID,-1) AS Emp_ID  "
	sSQLDocs += " ,ISNULL(Tb2.Docs_ID,-1) AS Docs_ID "
	sSQLDocs += " ,Docs_Validado "
	sSQLDocs += " ,Tb2.Docs_Nombre, Tb2.Docs_Titulo, Tb2.Docs_RutaArchivo , Tb2.Docs_FechaRegistro "
	sSQLDocs += " , ISNULL((CONVERT(NVARCHAR(20),Tb2.Docs_FechaRegistro, 103)),'') as FechaRegistro "
	...
	sSQLDocs += " , (CASE ISNULL(Tb2.Docs_FechaRegistro,-1) WHEN -1 THEN 0 ELSE 1 END) AS Cargado "
	sSQLDocs += " FROM Cat_Documento DOC "
	sSQLDocs += " LEFT OUTER JOIN Empleado_Documentos Tb2 "
	sSQLDocs += " ON DOC.Doc_ID = Tb2.Doc_ID "
	sSQLDocs += " AND Tb2.Emp_ID = " + Emp_ID
	sSQLDocs += " WHERE  DOC.Doc_Habilitado = 1 "
	...
	sSQLDocs += " AND DOC.Doc_NivelEmpleado = 1 "
	sSQLDocs += " ORDER BY DOC.Doc_Orden "
...
/*if (NivelVentana == 5 ) {
	...
	ArchivoJS = "/pz/cop/Documentos/Vehiculo/DocumentosVehiculo.js"
	PK = "Veh_ID"
	PKValor = Veh_ID
...
var sSQLDocs  = " SELECT DOC.Doc_ID, DOC.Doc_Nombre, ISNULL(Tb2.Veh_ID,-1) AS Veh_ID  "
	...
	sSQLDocs += " AND DOC.Doc_NivelVehiculo = 1 "
	sSQLDocs += " ORDER BY DOC.Doc_Orden "
...
if (NivelVentana == 5 ) {
	...
	ArchivoJS = "/pz/cop/Documentos/DocumentosProveedor.js"
	PK = "Prov_ID"
	PKValor = Prov_ID
...
<script type="text/javascript">
	   ...
	   //LlamaDocumento(<%=Veh_ID%>,<%=Doc_ID%>,<%=Docs_ID%>,<%=Cargado%>)
