	...
	switch (parseInt(Tarea)) {
		...
		case 1:  //Guardando documento
			try {
					...
					sSQLACT =  " INSERT INTO Proveedor_OrdenCompra_Documento (Prov_ID, OC_ID, Doc_ID "
					sSQLACT += ", Docs_Nombre, Docs_RutaArchivo, Docs_Titulo, Docs_Observaciones) " 
					sSQLACT += " VALUES (" + Prov_ID + "," + OC_ID + "," + Doc_ID
		...
		case 2:  //Borrando documento de la bd
			try {
				...
				var sSQLACT =  " DELETE FROM Proveedor_OrdenCompra_Documento "	
		...
		case 4:  //Borrando documento de la bd
			try {
				...
				var sSQLACT =  " UPDATE Proveedor_OrdenCompra_Documento "	
