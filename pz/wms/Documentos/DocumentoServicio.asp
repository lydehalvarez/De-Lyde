...
<% if(NombreXML != "") {%>
	...
	var url = "/Media/agt/Servicio/<%=NombreXML%>";
...
function DocGuardar(){
	$.post("/pz/agt/Documentos/DocsServicio_Ajax.asp"
	  , { Tarea:5,Ser_ID:$("#Ser_ID").val(),Doc_ID:$("#Doc_ID").val(),Docs_ID:$("#Docs_ID").val() 
