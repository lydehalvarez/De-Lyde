...
DIM Cli_ID
	Cli_ID = Request.QueryString("Cli_ID")
	DIM CliOC_ID
	CliOC_ID = Request.QueryString("CliOC_ID")
...
DIM sResultado
	...
	'Response.End()
%>
<!--#include file="uploadClienteOC.asp" -->
<%
...
Else
	For Each File In Uploader.Files.Items    
		...
		sResultado = "OK|" & Cli_ID & "_"  & CliOC_ID & "_" & Doc_ID & "_" & Docs_ID & "_" & sfile
