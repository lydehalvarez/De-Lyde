	...
	switch (parseInt(Tarea)) {
		...
		case 1:  //Guardando documento
			try {
				...
				var sSQLACT =  " INSERT INTO Empleado_Documentos (Emp_ID, Doc_ID, Docs_ID "
					sSQLACT += ", Docs_Nombre, Docs_RutaArchivo, Docs_Titulo, Docs_Observaciones) " 
					sSQLACT += " VALUES (" + Emp_ID + "," + Doc_ID + "," + Docs_ID 
		...
		case 2:  //Borrando documento de la bd
			try {
				...
				var sSQLACT =  " DELETE FROM Empleado_Documentos "	
		...
		case 3:  //Buscando el siguiente ID
			try {	
				...
				sResultado = SiguienteID("Docs_ID","Empleado_Documentos",sCondicion,0)
		...
		case 4:  //Borrando documento de la bd
			try {
				...
				var sSQLACT =  " UPDATE Empleado_Documentos "	
