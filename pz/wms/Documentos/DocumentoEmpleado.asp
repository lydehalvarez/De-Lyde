...
<% if(NombreXML != "") {%>
	...
	var url = "/Media/agt/Empleado/<%=NombreXML%>";
...
function DocGuardar(){
	$.post("/pz/agt/Documentos/DocsEmpleado_Ajax.asp"
	  , { Tarea:5,Emp_ID:$("#Emp_ID").val(),Doc_ID:$("#Doc_ID").val(),Docs_ID:$("#Docs_ID").val() 
