...
<%
	...
	var BPM_Flujo = ""
	var BPM_Estatus = ""	
    var ModoConfiguracion = ParametroDeVentanaConUsuario(SistemaActual, VentanaIndex, IDUnica, "Modo Configuracion",0)
    Response.Write("<br> SistemaActual = " + SistemaActual)
    Response.Write("<br> VentanaIndex = " + VentanaIndex)
    Response.Write("<br> IDUnica = " + IDUnica)
    Response.Write("<br> ModoConfiguracion = " + ModoConfiguracion)
...
if (CliOC_ID > -1 ) { 
   ...
   var rsTP = AbreTabla(sSQL1,1,0)
	...
	rsTP.Close()
	 Response.Write("<br>formulario " + For_Archivo )
		 ...
		 <div class="ibox-title">
			...
			<div class="ibox-tools">
				...
				<ul class="dropdown-menu dropdown-user">
                    <li><a href="#" data-mnuid="1" class="cfgCambia">Paso actual</a></li>
					<li><a href="#" data-mnuid="2" class="cfgCambia">Estatus</a></li>
					<li><a href="#" data-mnuid="3" class="cfgCambia">Roles</a></li>
                    <li><a href="#" data-mnuid="4" class="cfgCambia">Flujo</a></li>
            ...
            <div class="ibox-content" style="display:none" id="dvConfContenido">
            </div>		
        </div>
  <% } %>                      
...
<% if(ModoConfiguracion==1 ){ %>       
		$('#dvConfContenido').load('/pz/wms/BPM/Cfg_PasoActual.asp?' + Paramts);
                             
        $(".cfgCambia").click(function(e){
            e.preventDefault()
            var Ventana = $(this).data("mnuid")
            var sRuta = ""
            switch (parseInt(Ventana)) {
		      case 1:
                    sRuta = "Cfg_PasoActual.asp"
              break; 
             case 2:
                    sRuta = "Cfg_Estatus.asp"  
              break;      
		      case 3:
                    sRuta = "Cfg_Roles.asp"  
              break;  
            ...
            if(sRuta != ""){
                $('#dvConfContenido').load('/pz/wms/BPM/' + sRuta + '?' + Paramts);
            }
