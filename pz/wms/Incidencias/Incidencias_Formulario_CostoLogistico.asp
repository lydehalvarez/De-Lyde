...
%>
                   ...
                   <div class="form-group">
                      ...
                      <div class="form-group">
                         <label class="control-label col-md-3"><strong>Fecha Aviso</strong></label>
                       <div class="col-md-9">
                         <input class="form-control date-picker date" id="FechaAviso"   placeholder="dd/mm/aaaa" type="text" value="" 
                      ...
                      <div class="col-md-12">
                       ...
                       <div class="col-md-3">
  						...
  						<label class="control-label col-md-3" style="display:none"><strong>No. de tienda</strong></label>
                       <div class="col-md-3">
                           <input class="form-control Tienda" placeholder=""  style="display:none"></input>
                       </div>
                       </div>
              		 </div>
                   <div class="form-group">
