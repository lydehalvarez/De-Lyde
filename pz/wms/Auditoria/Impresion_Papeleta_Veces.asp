...
<%
    ...
    var OrdenarUbicacion = Parametro("OrdenarUbicacion", 0)
    ...
    var sqlLpn = "SELECT AUU.AudU_Veces,AUU.PT_ID "
        ...
        if( OrdenarUbicacion == 1 ){
            sqlLpn += " ORDER BY Ubi.Ubi_Indice ASC, AUP.PT_SKU "
        } else {
            sqlLpn += " ORDER BY Ubi_Nombre ASC, AUP.PT_SKU "
        }
