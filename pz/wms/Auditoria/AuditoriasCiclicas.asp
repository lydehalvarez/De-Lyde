                                ...
                                <div class="row"> 
                                    ...
                                    <div class="col-sm-4 m-b-xs">
                                        <% 
                                            ...
                                            var sCondicion = "";
                                            CargaCombo("cbCli_ID", sEventos, "Cli_ID", "Cli_Nombre", "Cliente", "", "Cli_Nombre", -1, 0, "No aplica", "Editar");
                                        %>
                                    </div>
...
function CargarGrid(tab) {
	$("#dvTablaAuditorias").hide('slow',function(){
    ...
    var dato = {
        Lpp: 1,
        Cli_ID: $('#cbCli_ID').val(),
        AuditType: $('#cbAudType').val(),
        FechaInicio: $('#inicio').val(),
        FechaFin: $('#fin').val(),
        AuditEstatus: $('#cbEstatus').val(),
        Auditor: $('#cbAuditor').val()
    }
    $("#dvTablaAuditorias").load(tab, dato,function(data){
...
var AudiCiclica = {
	...
	VerAuditoria:function(Audi_ID,Cli_ID){
