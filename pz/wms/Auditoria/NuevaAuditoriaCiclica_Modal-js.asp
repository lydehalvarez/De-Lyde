<script type="text/javascript">
	    ...
	    $.post( "/pz/wms/Auditoria/AuditoriaCiclicas_ajax.asp",
            ...
            function(data){
				...
				if(response.result == 1){
					sTipo = "success";  
					$("#Contenido").load("/pz/wms/Auditoria/AuditoriasCiclicas.asp")
				}
    ...
    function getRequest() {
        ...
        return {
			...
			Aud_EsCiego:$('input:radio[name=rdCiego]:checked').val(),
            Aud_VisitasContinuas:$('input:radio[name=rdContinua]:checked').val(),
            Aud_HayConteoExterno:$('input:radio[name=rdExterno]:checked').val()
        }
    }
