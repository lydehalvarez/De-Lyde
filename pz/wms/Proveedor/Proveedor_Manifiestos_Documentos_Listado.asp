...
%>
     <div class="ibox">
        <div class="ibox-title">
            <h5 class="text-navy">
                <i class="fa fa-archive"></i> Documentos de Manifiesto
            </h5>
            <div class="ibox-tools">

                <label class="pull-right form-group">
                    <span class="text-success" id="lblManDocManLisTot">
        ...
        <div class="ibox-content">
            <table class="table table-hover">
                <tbody id="tbManDocManLis">
<%
while(!(rsManDoc.EOF)){
%> 
                    <tr class="cssTrManDocManLisReg">
                        <td>
                            <%= rsManDoc("ID").Value %>
                        </td>
                        <td>
                            <a onclick='Manifiesto.Documentos.Visualizar({Arc_Nombre: "<%= rsManDoc("Docs_Nombre").Value %>", Arc_Ruta: "<%= rsManDoc("Docs_RutaArchivo").Value %>"});'>
...
%>
                ...
                <tfoot>
                    <tr>
                        <td id="tfManDocManLisCar" colspan="4">
