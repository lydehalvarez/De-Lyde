...
<div class="form-group">
    ...
    <div class="col-xs-5">
	  ...
	  if(Cli_ID>-1){
        ...
        CargaCombo("RepCli_ID"," class='form-control' id='form-field-select-2' ","Cli_ID","Cli_Nombre","Cliente",sCond,"Cli_Nombre",Parametro("RepCli_ID",-1),0,"Todas",0)
...
<div class="form-group">
    ...
    <div class="col-xs-5">
      ...
      sCond += " AND CliPrv_ID = -1"   
        ...
        CargaCombo("CliPrv_ID"," class='form-control' id='form-field-select-2' ","CliPrv_ID","CliPrv_Nombre","Cliente_Proveedor",sCond,"CliPrv_Nombre",Parametro("CliPrv_ID",-1),0,"Todos",0)
      %>
    </div>
</div>
<% } else { %>
...
<div class="col-md-12">
        ...
        <div class="col-md-offset-10 ">
            <button class="btn btn-primary col-md-12 btnJsonExcel"><i class="clip-download-3"></i>Exportar a excel</button>
<!--             <a class="btn btn-primary col-md-12 btnJsonExcel" title="Exportar a excel" 
                href="javascript:ImprimeJson(<%=Rep_ID%>,1,1);">
             <i class="clip-download-3"></i>&nbsp;Exportar  a excel</a>
-->     </div>	
        <div class="col-md-offset-10">
