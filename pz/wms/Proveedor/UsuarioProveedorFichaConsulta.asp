...
<%
  ...
  if (ibIQ4Web) { Response.Write("<br>Prov_ID:&nbsp;"+iProvID + " | Prov_Usu_ID:" + iProvUsuID + " | Acc: " + iAcc) }
...
//hide("slow")
  $(document).ready(function() { 
    ...
    $("#btnBorrar").click(function (){
        ...
        $.post("/pz/wms/Proveedor/UsuarioProveedorFicha_Ajax.asp", { Tarea:3,Prov_ID:$("#Prov_ID").val(),Prov_Usu_ID:$("#Prov_Usu_ID").val() },
          function(data){
