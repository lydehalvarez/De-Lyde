...
sSQL = " SELECT TOP(5) i.Ins_ID, Ins_Asunto, Ins_Descripcion, i.Ins_FechaRegistro, Ins_Usu_Reporta, Ins_Usu_Recibe, CAST(DATEADD(HOUR, t.InsT_SLAAtencion+ " 
		 ...
		 + " OR p.Ins_UsuarioID=" + Usuario+ ") and (InsT_PrioridadCG33 > 3 or InsT_SeveridadCG32 > 3 or InsT_TallaCG25 >4 or "
		 + " InsT_SeveridadCG32 > 4 or InsT_EstrellasCG33 > 3) AND i.Ins_EstatusCG27 <> 4 "
...
%>
                            ...
                            <%
						 	if(Horas < 0){
						 %>
                           <div class="sidebar-message" style="background-color:red">
                    <%
							}else if(Horas < 4 && Horas > 0){
					%>
                           <div class="sidebar-message" style="background-color:yellow">
					<%
							}else{
                    %>
                            <div class="sidebar-message">
                    ...
                    %>
						 ...
						 %>
                                 ...
                                 <font color="#FFFFFF"><strong><%=Usuario%></strong>
									<br />
                                ...
                                <strong>Descripcion:</strong> <%=Descripcion%> 
                                 ...
                                 <br />
                                 <strong>Vencio hace: <%=Horas%> horas</strong> </font>
                         <%
							}else{
%>
        					<div class="media-body">
