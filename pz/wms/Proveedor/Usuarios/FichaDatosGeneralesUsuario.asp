  ...
  $(document).ready(function() {  
    ...
    $("#btnGuardarEdicion").click(function (){
      ...
      //console.log($("#Usu_Email").val());
        ...
        $.post("/pz/wms/Proveedor/Usuarios/DatosGeneralesUsuario_Ajax.asp",{
    ...
    function CargaFichaConsulta(ijqAcc) {
      ...
      var sData  = "Prov_ID="+$("#Prov_ID").val()
          ...
          sData += "&Acc="+ijqAcc;
          //console.log(sData);
          $("#divConsulta").load("/pz/wms/Proveedor/Usuarios/FichaDatosGeneralesUsuarioConsulta.asp?"+sData);	
          //$("#divEditar").hide("slow");
