                  ...
                  <div class="col-sm-12 m-b-xs">
                    <div class="row">
                      ...
                      <div class="col-sm-4 m-b-xs">
                          <input class="input-sm form-control" id="Folio" style="width:200px" type="text" value="">
                      </div>
                      <label class="col-sm-2 control-label">Gu&iacute;a:</label>
                      <div class="col-sm-3 m-b-xs">
                        <input class="input-sm form-control" id="Guia" style="width:200px" type="text" value="">
                      </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-4 m-b-xs">
                        <input class="input-sm form-control" id="OV_CUSTOMER_SO" style="width:200px" type="text" value=""><span class="help-block m-b-none"><i class="fa fa-question-circle"></i>&nbsp;OV_CUSTOMER_SO</span>
                      </div>
                    </div>
                    <!--div class="row">
                      <label class="col-sm-2 control-label">Rango fechas:</label>
                      <div class="col-sm-4 m-b-xs">
                        <input class="form-control date-picker date" id="FechaBusqueda" placeholder="dd/mm/aaaa" style="width: 200px;float: left;" type="text" value=""> <span class="input-group-addon" style="width: 37px;float: left;height: 34px;"><i class="fa fa-calendar"></i></span>
                      </div>
                    </div-->
                  </div>
                </div>
   ...
   $('.cbo2').select2();
    ...
    $('#FechaBusqueda').daterangepicker({
      ...
      $("#btnBuscar").click(function(event) {
            ...
            $("#dvTablaOrdenVenta").load("/pz/wms/Izzi/OrdenVenta/B_OrdenVenta_Grid.asp",dato);
