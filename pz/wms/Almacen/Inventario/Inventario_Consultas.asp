                            ...
                            <div class="col-sm-12 m-b-xs" id="ciclicAuditsFilters">    
                                <div class="row"> 
                                    ...
                                    <div class="col-sm-1 m-b-xs" style="text-align: left;">  
                                        <button class="btn btn-primary btn-sm" type="button" id="btnNew" data-toggle="modal" data-target="#newModal"><i class="fa fa-search"></i>&nbsp;&nbsp;<span class="bold">Nuevo</span></button>
                                    </div>
                                    <div class="col-sm-1 m-b-xs" style="text-align: left;">  
