...
%>
    <div class="ibox">
        <div class="ibox-title">
            <h5>LPNs en la ubicaci&oacute;n: <span class="text-info"><%=Ubi_Nombre%></span></h5>
        </div>
        <div class="ibox-content">
            <div class="table-responsive"> <!--issue-tracker-->
...
%>
                      <tr>
                          ...
                          <td class="text-center"><%=rsUbi("Pt_ConteoFisico").Value %></td>      
                          <td class="text-center"><%=rsUbi("PT_Cantidad_Actual").Value %></td>
                          <td class="text-center">
                              <a class="btn btn-danger btn-xs" title="Quitar LPN de la ubicaci&oacute;n"
