...
<script type="text/javascript">
    ...
    var AsignacionRFID = {
        ...
        , IMEI: {
            Escanear: function( evento ){
                ...
                if (intTecla == 13){
	 				var RFID = $("#inpRFID").val()

					if(RFID != ""){
					// ACTUALIZACION DE IMEI ERRONEO BUSCANDO EL RFID 
						FunctionIMEI.ActualizaIMEI();
					}else{
					    if(strIMEI != ""){
	...
	var FunctionIMEI = {
			ActualizaIMEI:function(){
				
					$.ajax({
    method: "POST",
    url: "/pz/wms/Almacen/Asignacion_RFID_ajax.asp?",
    data: {Tarea:3212,
		IMEI:$('#inpIMEI').val(),
		RFID:$('#inpRFID').val()
			},
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4 m-b-xs">
                                ...
                                <a id="btnAsignar" class="btn btn-info">
                                    <i class="fa fa-barcode"></i> Asignar EPC
                                </a>
