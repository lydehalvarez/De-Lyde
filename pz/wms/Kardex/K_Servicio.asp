...
<% 
    ...
    CargaCombo("Kdx_ID", sEventos, "Kdx_ID", "Kdx_Descripcion", "BI_Kardex", "", "Kdx_Descripcion"
              , Parametro("Kdx_ID",-1), 0, "Seleccione", "Editar")
%>
                        </div>
            ...
            <div class="table-responsive" id="dvTablaDatos"></div>  
          </div>
        </div>
      </div>
    </div>
...
//    CargaGridInicial()
    ...
    function CargaGridInicial(){
        ...
        $("#dvTablaDatos").load("/pz/wms/Kardex/K_Servicio_Grid.asp");
