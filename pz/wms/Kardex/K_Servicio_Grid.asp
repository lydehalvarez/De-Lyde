  ...
  <table class="table table-hover">
    <tbody>
      <tr>
          ...
          <th width="155" class="project-title">OV Salidas
            <br/>
            <small>Entrega a B2C</small></th>
          <th width="155" class="project-title">OV Entradas
            <br/>
            <small>RMA/DOA</small></th>
          <th width="155" class="project-title">TRA Salidas
            <br/>
            <small>Transferencias B2B</small></th>
          <th width="155" class="project-title">TRA Entradas
            <br/>
            <small>Recepciones B2B</small></th>
      ...
      <tr>
        ...
        <td class="project-title">
           <%=rsKardex.Fields.Item("Kdx_Cantidad_OV_out").Value%>
        </td>
        <td class="project-title">
           <%=rsKardex.Fields.Item("Kdx_Cantidad_OV_in").Value%>
        </td>
        <td class="project-title">
           <%=rsKardex.Fields.Item("Kdx_Cantidad_TA_out").Value%>
        </td>
        <td class="project-title">
           <%=rsKardex.Fields.Item("Kdx_Cantidad_TA_in").Value%>
        </td>   
         <td class="project-title">
