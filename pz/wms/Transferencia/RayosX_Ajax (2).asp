...
<%
 ...
 switch (parseInt(Tarea)) {
	...
	case 1:
		...
		if(TA_ID > -1){
			var Producto = "SELECT Pro_Nombre, TAA_CantidadPickiada  AS CANTIDAD "
			...
			if(TA_FechaRayosX == ""){
				if(TA_EstatusCG51 = 3){
					var Pickeado = BuscaSoloUnDato("SUM(TAA_CantidadPickiada)","TransferenciaAlmacen_Articulos"," TA_ID = " + TA_ID,-1,0)
