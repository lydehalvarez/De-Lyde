...
<%
	...
	var Ultima =  BuscaSoloUnDato("MAX(TA_Orden)","TransferenciaAlmacen","TA_ArchivoID = "+TA_ArchivoID,-1,0);
...
<div class="row" style="margin-bottom:25px">
    <div class="col-md-6"><h4><strong>Ultima orden asignado: <%=Ultima%></strong></h4></div>
...
<table class="table">
	...
	%>
        <tr>
        	<td colspan="3">Sin informaci&oacute;n de <%=Dato%></td>
        </tr>
    <%
	}
	%>
