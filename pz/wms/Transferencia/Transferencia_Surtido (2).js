...
$('.btnEtiquetas').click(function(e) {
	...
	var newWin=window.open("http://wms.lyde.com.mx/pz/wms/Transferencia/EtiquetasTransferencia.asp?TA_ArchivoID="+TA_Archivo);
...
function SeriesTransferencia(datos,Th){
	...
	$.ajax({
		...
		data: myJSON,
		contentType:'application/json',
		url: "https://wms.lydeapi.com/api/s2012/WMS/Picking/Transferencias",
