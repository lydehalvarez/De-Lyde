...
-->                                                       
                                            ...
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                               ...
                                               <input type="button" value="Env&iacute;ar datos"  data-taid="<%=TA_ID%>"
                                                       style="margin-right: 5px;width: 113px; margin-top: 5px;display:none;"
                                                       class="btn btn-success btnSinRuta"/>
                                               <br />
                                            ...
                                            <table  style="font-size:initial;color: black;" class="table table-hover table_<%=TA_ID%>">
                                                ...
                                                <tbody>
													...
													if(ArmaKit){
														...
														var	Data = " SELECT TA_ID,-1 TAA_ID,TAA_SKU,SUM(TAA_Cantidad) Cantidad,a.Pro_ID,SUM(TAA_CantidadPickiada) Pickeada,1 Original,'' Ubicacion,Pro_Nombre Producto,Pro_EsSerializado Serializado" 
															...
															Data += " AND a.Pro_ID in (2223,3093) "
															Data += " AND a.Pro_ID = b.Pro_ID " 
															Data += " GROUP BY TA_ID,a.Pro_ID,TAA_SKU,Pro_Nombre,Pro_EsSerializado,Pro_EsSerializado " 
															Data += " UNION " 
														    Data += " SELECT TA_ID,TAA_ID,TAA_SKU,TAA_Cantidad,a.Pro_ID,TAA_CantidadPickiada,0  Original,[dbo].[fn_Ubica_rack_SKU] (6,8,TAA_SKU) as Ubicacion   "
															...
															Data += " FROM TransferenciaAlmacen_Articulos a , Producto b "
															Data += " WHERE TA_ID = " + TA_ID
															Data += " AND a.Pro_ID not in (2223,3093) "
															Data += " AND a.Pro_ID = b.Pro_ID " 
														...
														var Data = " SELECT * "
															...
															Data += " ,TAA_CantidadOriginal Original"
															Data += " ,(SELECT COUNT(*) FROM TransferenciaAlmacen_Articulo_Picking WHERE TA_ID = a.TA_ID AND TAA_ID = a.TAA_ID) Pickeados "
                                                    ...
                                                    var rsArt = AbreTabla(Data,1,0)
                                                        ...
                                                        while(!rsArt.EOF){
															var ACantidad = 0
                                                            TAA_SKU = rsArt.Fields.Item("TAA_SKU").Value 
                                                            TAA_ID = rsArt.Fields.Item("TAA_ID").Value 
                                                            Producto = rsArt.Fields.Item("Producto").Value 
                                                            Ubicacion = rsArt.Fields.Item("Ubicacion").Value 
                                                            TAA_Cantidad = rsArt.Fields.Item("Cantidad").Value 
                                                            Pickeados = rsArt.Fields.Item("Pickeados").Value 
															Serializado = rsArt.Fields.Item("Serializado").Value
															Pro_ID = rsArt.Fields.Item("Pro_ID").Value
															EsKit = rsArt.Fields.Item("Original").Value 
															Color = ""
															if(Pro_ID == 2192 ||Pro_ID == 5343 ||Pro_ID == 5709){
																ACantidad = 1	
															}
                                                            if(Ubicacion == ""){
...
var Kit = {
	NuevoKit:function(arr){
		...
		setTimeout(function(){$('#RFID_'+arr.TA_ID+'_'+arr.Pro_ID).focus()},1000)
	},
