            ...
            <div class="ibox float-e-margins">
                <div class="ibox-content">
                    <div class="form-group">
                     ...
                     <div id="TablaTRA" class="col-md-12"></div>
					<div id="TablaCorte">
...
$('.btnCortePicking').click(function(e) {
	...
	if(longi > 0){
		...
		swal({
			  title: "No hay elemnetos para hacer un corte",
			  text: "*Intentar m&aacute;s tarde ya que no hay datos para generar un corte :(",
			  type: "warning",
			  confirmButtonClass: "btn-success",
			  confirmButtonText: "Ok" ,
			  closeOnConfirm: true,
