...
<title>Transferencia <%=TA_ArchivoID%></title> 
<table width="100%">
  <tbody>
    <tr>
      ...
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td><svg class="barcode"  jsbarcode-value="TRA-<%=TA_ArchivoID%>-C" jsbarcode-width="2" jsbarcode-height="20"jsbarcode-fontSize="8"></svg></td>
      <td align="right">Abastecimiento <%=TA_ArchivoID%></td>
    </tr>
    <tr>
    ...
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td>Surtido de transferencia</td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
...
<%
   	...
   	var sSQL3 = "SELECT  "
		...
		sSQL3 += ",ISNULL((SELECT Pro_Nombre FROM Producto WHERE Pro_SKU =h.TAA_SKU ),'') Pro_Nom "
		sSQL3 += ",(SELECT Pro_Descripcion FROM Producto WHERE Pro_SKU =h.TAA_SKU ) Pro_Descrip "
