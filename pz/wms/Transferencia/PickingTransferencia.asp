...
<%
	TA_ArchivoID = Parametro("TA_ArchivoID",-1)
	var Transfer = "SELECT * "
		//Transfer += " ,(SELECT Alm_Nombre FROM Almacen a WHERE  a.Alm_ID = h.TA_Start_Warehouse) Origen "
		//Transfer += " ,(SELECT Alm_Nombre FROM Almacen a WHERE  a.Alm_ID = h.TA_End_Warehouse) Destino "
...
<div class="wrapper wrapper-content animated fadeInRight">
	<div class="row">
        <div class="col-md-12">
            ...
            <div class="ibox">
                    <div class="col-md-3">
						<%CargaCombo("TA_ArchivoID"," class='form-control '","TA_ArchivoID","TA_ArchivoID","TransferenciaAlmacen_Archivo","","",-1,0,"Selecciona","Editar")%>
                    </div>
                            ...
                            <table class="table shoping-cart-table">
                                ...
                                <tr>
                                    <td class="desc">
                                        ...
                                        <h4 class="text-navy">
                                            Origen <%=rsTran.Fields.Item("TA_Start_Warehouse").Value%>
                                        </h4>
                                        <h4 class="text-navy">
                                            Destino <%=rsTran.Fields.Item("TA_End_Warehouse").Value%>
                                        </h4>
...
$('#TA_ArchivoID').change(function(e) {
	$.post("/pz/wms/Transferencia/Transferencia_Ajax.asp",{
	TA_ArchivoID:$('#TA_ArchivoID').val()
	}
    , function(data){
	$('#Transferencia').load("/pz/wms/Transferencia/PickingTransferencia.asp?TA_ArchivoID="+$('#TA_ArchivoID').val())
