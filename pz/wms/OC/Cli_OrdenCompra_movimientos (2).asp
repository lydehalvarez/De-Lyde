...
//HA ID: 3  2020-SEP-11 Se agregan paneles de acordeón a productos
...
//HA ID: 3 Se agrega campo de Identificador de Producto
...
var bolHayCar = false
var i = 0
var j = 0       //HA ID: 3 Identificador de Panel(Acordeon)
%>
...
//HA ID: 3 INI Se agrega paneles de acordeón
%>		
	                        <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h5 class="panel-title">
                                        <a class="form-group row" data-toggle="collapse" data-parent="#accordion" href="#collapse<%= j %>">
...
%>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="#" data-toggle="modal" data-target="#CargaLogModal" title="Ver Log de Carga"
                                                            ...
                                                            <a href="#" onclick='Serie.Ver(<%= rsCliOCP("LOT_Id").Value %>, <%= rsCliOCP("Pro_ID") %>)' title="Ver Numeros de series">
