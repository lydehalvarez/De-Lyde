...
<!--
	$(document).ready(function() { 
		...
		var sDatos  = "?OC_ID=" + $("#OC_ID").val() 
			...
			$("#dvCuerpoDatos").load("/pz/fnd/OC/OC_Comprobacion_Carga.asp" + sDatos);
		...
		var sDatos  = "?OC_ID=" + $("#OC_ID").val() 
			...
			$("#dvCuerpoDatos").load("/pz/fnd/OC/OC_Comprobacion_Grid.asp" + sDatos);
	...
	function CargaGridFacturas(){
		...
		$("#dvCuerpoDatos").load("/pz/fnd/OC/OC_Comprobacion_Grid.asp" + sDatos);
		$("#dvSumas").load("/pz/fnd/OC/OC_Comprobacion_Sumas.asp" + sDatos);
	}
