        ...
        <div class="table-responsive">
            ...
            <div class="fileinput fileinput-new input-group" data-provides="fileinput">
                ...
                <a href="#" class="input-group-addon btn btn-default fileinput-exists" 
                   id="btnQuitar" data-dismiss="fileinput">Quitar</a>
            ...
            <div class="form-group vp3">               
                <div class="col-sm-12" style="text-align:center">	
                	<iframe id="PreviewPDF" frameborder="0" scrolling="no" width="650" height="1100"></iframe>
                </div>        
            </div> 
                ...
                <tbody>
                    <tr style="width: 80%;text-align: left;">
                        ...
                        <td>
                            ...
                            <p  style="font-size: large;font-weight: bold;" id="xmlRFC">Emisor:</p>
                            <p  style="font-size: large;font-weight: bold;" id="dUUID">UUID:</p>
                            <p  style="font-size: large;font-weight: bold;" id="dFolio">Folio:</p>
                            <div class="m-t-sm">
...
function CargaArchivoAlServidor() {			
	...
	var sRutaArch = "/Media/aura/upload/";	
		  ...
		  , function(msg){
			  if (msg == "OK" ) {
					...
					if ($("#EsXML").val() == 1 ) {
						...
						$("#Tipo").val(2);
						$.post( "/pz/fnd/Tesoreria/Ajax.asp"
						    , { Tarea:16,OC_ID:<%=OC_ID%>,Doc_Nombre:sNomArchivo,Usu_ID:$("#IDUsuario").val(),Doc_ID:7,Docs_ID:$("#Docs_ID").val()}
					...
					if ($("#EsPDF").val() == 1 ) {
						...
						$("#Tipo").val(1);
						$.post( "/pz/fnd/Tesoreria/Ajax.asp"
						    , { Tarea:17,OC_ID:<%=OC_ID%>,Doc_Nombre:sNomArchivo,Usu_ID:$("#IDUsuario").val(),Doc_ID:7,Docs_ID:$("#Docs_ID").val()}
