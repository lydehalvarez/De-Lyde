...
//   var rsTP = AbreTabla(sSQL1,1,0)
	...
	if(CliOC_ID > -1){
   	    var sSQL1  = "SELECT "
                   ...
                   +         " ON Cliente_OrdenCompra_EntregaProducto.CliOC_ID = Cliente_OrdenCompra_Entrega.CliOC_ID "
                                ...
                                <tbody>
                                 ...
                                 <td class= "desc">
                                        ...
                                        var Limiteishon = 0
                                            while(!rsArt3.EOF){
                                                    if(CliOC_ID > -1){
                                        Cantidad = rsArt3.Fields.Item("CliEnt_ArticulosRecibidos").Value 
                                                    }
                                                        if(TA_ID > -1){
                                        Cantidad = rsArt3.Fields.Item("TAA_Cantidad").Value 
                                                        }
                                                            if(OC_ID > -1){
                                        Cantidad = rsArt3.Fields.Item("OCP_Cantidad").Value 
                                                    }
                                        %>		
                                            <h4><%=Cantidad%></h4>
