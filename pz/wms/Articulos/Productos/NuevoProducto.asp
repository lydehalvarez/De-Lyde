            ...
            <div class="ibox float-e-margins">
                <div class="ibox-content">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                         <%CargaCombo("TPro_ID"," class='form-control getdatos' ",
                            "TPro_ID","TPro_Nombre","Cat_TipoProducto","","TPro_Nombre",
                            Parametro("TPro_ID",-1),0,"Selecciona","Editar")%>
                         </div>
                     </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-3 required">SKU alterno</label>
                        <div class="col-lg-8">
                            <input placeholder="SKU"  value="<%=Parametro("Pro_ClaveAlterna","")%>" autocomplete="off" class="form-control getdatos" id="Pro_ClaveAlterna" type="text">
                        </div>
                    </div>
                </div>
            </div>
...
function FileUploadPro(file){
	...
	$.ajax({
		...
		url: 'http://198.38.94.238:8543/api/UploadFile',
