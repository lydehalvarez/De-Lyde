...
//		
//		} else {
			Response.Write("Configure por favor el query del grid (err 88)")	
//		}
...
<% 
			...
			Response.Write("Configure por favor el query del grid (err 159)")	
		}
...
<% 
			...
			Response.Write("Configure por favor el query al grid (err 217)")		
		}
...
<% 
			...
			Response.Write("Configure por favor el query al grid  (err 268)")	
		}
...
<% 
			...
			Response.Write("Configure por favor el query al grid (err 319)")	
		}
...
<% 
			...
			Response.Write("Configure por favor el query al grid (err 378)")		
		}
	...
	if( PlantillaPantalla_ID == 8) { 
		...
		if(Alr_QueryGrid != "") {
			...
			while (!rsAvisos.EOF){
				iRenglon++
				Llaves = Alr_ID
				Llaves += "," + rsAvisos.Fields.Item("TA_ID").Value	
				Llaves += "," + rsAvisos.Fields.Item("Cli_ID").Value	
				Llaves += "," + Parametro("Alr_SiguienteVentana",90)	
%> 
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="11%" scope="col">Folio</td>
    <td colspan="3" scope="col">&nbsp;<%=rsAvisos.Fields.Item("TA_Folio").Value%></td>
    </tr>
  <tr>
    <td nowrap="nowrap">&nbsp;</td>
    <td nowrap="nowrap">Folio cliente</td>
    <td width="47%">&nbsp;<%=rsAvisos.Fields.Item("TA_FolioCliente").Value%></td>
    <td width="9%">&nbsp;</td>
    <td width="23%"><a href="javascript:VerTransferencia(<%=Llaves%>)">ver Transferencia</a></td>

  </tr>
  <tr>
    <td valign="top" nowrap="nowrap">&nbsp;</td>
    <td valign="top" nowrap="nowrap">Estatus actual</td>
    <td colspan="2">&nbsp;<%=rsAvisos.Fields.Item("ESTATUS").Value%></td>
    <td>&nbsp;
    </td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td nowrap="nowrap">Fecha de elaborada</td>
    <td>&nbsp;<%=rsAvisos.Fields.Item("FechaElaboracion").Value%></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
</table>
...
<% 
    ...
    }  // fin del if PlantillaPantalla_ID == 8          
    if( PlantillaPantalla_ID == 9) { 
		...
		if(Alr_QueryGrid != "") {
			...
			while (!rsAvisos.EOF){
				iRenglon++
				Llaves = Alr_ID
				Llaves += "," + rsAvisos.Fields.Item("Alm_ID").Value	
				Llaves += "," + rsAvisos.Fields.Item("Cli_ID").Value	
				Llaves += "," + Parametro("Alr_SiguienteVentana",90)	
%> 
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="4%" scope="col">&nbsp;</td>
    <td width="11%" scope="col">Nombre</td>
    <td colspan="3" scope="col">&nbsp;
                <%=rsAvisos.Fields.Item("Alm_Numero").Value%> - 
                <%=rsAvisos.Fields.Item("Alm_Nombre").Value%></td>
    </tr>
  <tr>
    <td nowrap="nowrap">&nbsp;</td>
    <td nowrap="nowrap">Estado</td>
    <td width="47%">&nbsp;<%=rsAvisos.Fields.Item("Alm_Estado").Value%></td>
    <td width="9%">&nbsp;</td>
    <td width="23%"><a href="javascript:VerAlmacen(<%=Llaves%>)">ver Almac&eacute;n</a></td>

  </tr>
  <tr>
    <td valign="top" nowrap="nowrap">&nbsp;</td>
    <td valign="top" nowrap="nowrap">Ciudad</td>
    <td colspan="2">&nbsp;<%=rsAvisos.Fields.Item("Alm_Ciudad").Value%></td>
    <td>&nbsp;
    </td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td nowrap="nowrap">Cliente</td>
    <td>&nbsp;<%=rsAvisos.Fields.Item("cliente").Value%></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
</table>
...
<% 
    ...
    }  // fin del if PlantillaPantalla_ID == 9   
    if( PlantillaPantalla_ID == 10) { 
		...
		if(Alr_QueryGrid != "") {
			...
			while (!rsAvisos.EOF){
				iRenglon++
				Llaves = Alr_ID
				Llaves += "," + rsAvisos.Fields.Item("Pro_ID").Value	
				Llaves += "," + Parametro("Alr_SiguienteVentana",90)	
%> 
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="4%" scope="col">&nbsp;</td>
    <td width="11%" scope="col">Nombre</td>
    <td colspan="3" scope="col">&nbsp;<%=rsAvisos.Fields.Item("Pro_Nombre").Value%></td>
    </tr>
  <tr>
    <td nowrap="nowrap">&nbsp;</td>
    <td nowrap="nowrap">Descripci&oacute;n</td>
    <td width="47%">&nbsp;<%=rsAvisos.Fields.Item("Pro_Descripcion").Value%></td>
    <td width="9%">&nbsp;</td>
    <td width="23%"><a href="javascript:VerProducto(<%=Llaves%>)">ver Producto</a></td>

  </tr>
  <tr>
    <td valign="top" nowrap="nowrap">&nbsp;</td>
    <td valign="top" nowrap="nowrap">SKU</td>
    <td colspan="2">&nbsp;<%=rsAvisos.Fields.Item("Pro_SKU").Value%></td>
    <td>&nbsp;
    </td>
  </tr>
  <tr>
    ...
    <td>&nbsp;<%=rsAvisos.Fields.Item("Pro_Modelo").Value%></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
</table>
...
<% 
    ...
    }  // fin del if PlantillaPantalla_ID == 10            
...
function VerTransferencia(a,t,c,v){
