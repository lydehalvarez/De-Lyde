...
<%
    ...
    if (!rsOV.EOF){
		var CUSTOMER_NAME = rsOV.Fields.Item("OV_CUSTOMER_NAME").Value
		SHIPPING_ADDRESS =  rsOV.Fields.Item("OV_Calle").Value +", "+ rsOV.Fields.Item("OV_NumeroExterior").Value+", "+ rsOV.Fields.Item("OV_NumeroInterior").Value+", "+ rsOV.Fields.Item("OV_Colonia").Value+", "+ rsOV.Fields.Item("OV_Delegacion").Value+", "+ rsOV.Fields.Item("OV_Ciudad").Value+", "+ rsOV.Fields.Item("OV_Estado").Value+", "+ rsOV.Fields.Item("OV_Pais").Value
	}
