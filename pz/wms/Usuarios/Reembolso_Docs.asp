...
var Doc_ID = ParametroDeVentana(SistemaActual, VentanaIndex, "Tipo Documento", 7)
...
function CargaDocumento(dc,dcs){
	...
	var sData = "/pz/agt/Usuarios/Reembolso_Archivo.asp"
	    sData += "?Emp_ID=" + $("#Emp_ID").val()
		sData += "&ERmb_ID=" + $("#ERmb_ID").val()				
		sData += "&Doc_ID=" + dc
		sData += "&Docs_ID=" + dcs
...
function CargaResumenDeArchivos(dc,dcs){
	...
	var sData = "/pz/agt/Usuarios/Reembolso_Resumen.asp"
	    sData += "?Emp_ID=" + $("#Emp_ID").val()
		sData += "&ERmb_ID=" + $("#ERmb_ID").val()					
		sData += "&Doc_ID=" + dc
		sData += "&Docs_ID=" + dcs		
