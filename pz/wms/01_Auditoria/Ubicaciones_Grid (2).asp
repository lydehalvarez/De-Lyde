...
<table class="table table-striped table-bordered">
	<thead>
    	<tr>
        	...
        	<th width="15%">Ubicaci&oacute;n</th>
        	<th width="4%">LPN</th>
...
<%    
	...
	<tr class="articulos" id="Renglon<%=iRegistro%>">
        ...
        <td class="project-title" width="17%">
            <a class="Move" data-sku="<%=SKU%>">
            <%=rsInv.Fields.Item("Pro_Nombre").Value%>
            </a>
            <!-- br>
            <small>
                <%=rsInv.Fields.Item("Pro_Descripcion").Value%>
            </small  -->
        </td>
    	<td nowrap="nowrap"><%=rsInv.Fields.Item("Ubi_Nombre").Value%>
            <br><%= strArea %>  <%=sEtiqueta%>
        </td>
   	    <td nowrap="nowrap"><% Response.Write(rsInv.Fields.Item("Pt_LPN").Value) %></td>
