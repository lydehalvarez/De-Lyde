   ...
   switch (parseInt(Tarea)) {
		...
		case 2:	//busca un codigo de barras de una auditoria a recibir
            ...
            try {
				...
				var Auditor = BuscaSoloUnDato("Aud_Externo","Auditorias_Auditores","Aud_ID = "+Aud_ID+" AND Usu_ID = "+IDUsu_Auditor,-1,0)  
				
				if(Auditor > -1){
					var ValidaLPN = "SELECT AudU_CodigoBarras " +
									" FROM Auditorias_Pallet a, Auditorias_Ubicacion b " +
									" WHERE Pt_LPN = '"+CB+"'" +
									" AND a.Aud_ID = " + Aud_ID +
									" AND a.Aud_ID = b.Aud_ID " +
									" AND a.Pt_ID = b.Pt_ID " +
									" AND b.AudU_Veces = 1 " +
									" AND AudU_ConteoInterno = " +Auditor
