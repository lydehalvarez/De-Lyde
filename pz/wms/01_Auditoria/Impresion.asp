...
<%
    ...
    var iVistaActual = BuscaSoloUnDato("Aud_VisitaActual","Auditorias_Ciclicas",sCondicion,1,0)
                ...
                <div class="ibox-title">
                    ...
                    <div class="ibox-content">
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Visita:</label>
                                <div class="col-sm-4">
                                    <select name="cbAudUVeces" id="cbAudUVeces" class='input-sm form-control cbo2' style='width:200px'>
                                        <% 
                                            var sEventos = " class='input-sm form-control cbo2'  style='width:200px'"
                                            var sCondicion = "Aud_ID = "+Aud_ID+" AND Aud_VisitaActual ="+iVistaActual
                                           
                                            var sSQLVis = " SELECT Aud_VisitaActual FROM Auditorias_Ciclicas "
                                                sSQLVis += " WHERE " + sCondicion
                                                //Response.Write(sSQLVis)
                                             
                                           	 var sArmaCbo = ""
                                             var sSelec = Parametro("cbAudUVeces",-1)
                                             
                                             var rsVis = AbreTabla(sSQLVis,1,0)
                                                  
                                             while (!rsVis.EOF){
                                                 sArmaCbo = "<option value='"+ rsVis.Fields.Item(0).Value + "'"

                                                 if (sSelec == rsVis.Fields.Item(0).Value) {
                                                     sArmaCbo += " selected "
                                                 }
                                                 sArmaCbo += ">" + rsVis.Fields.Item(0).Value + "</option>"
...
<script type="text/javascript">
    ...
    function Imprimir(){
        ...
        if( bolError ){
			...
			var prm = "Aud_ID="+iAud_ID+"&PT_ID="+sPtIIDs+"&vez=<%=iVistaActual%>"
