    ...
    <div class="col-md-12">
        <div class="ibox float-e-margins">
            <legend class="col-sm-12">
                <h4>Buscar papeleta por c&oacute;digo de barras</h4>
            </legend>
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                       <%  var sEventos = " class='form-control cbo' "
						   ...
						   CargaCombo("Usu_ID",sEventos,"Usu_ID","(SELECT Nombre FROM [dbo].[tuf_Usuario_Informacion](Usu_ID)) Nombre","Auditorias_Auditores",sCondicion,"(SELECT Nombre FROM [dbo].[tuf_Usuario_Informacion](Usu_ID)) Nombre",-1,0,"Seleccione un auditor")
					   %>
                    </div>
                </div>
                <div id="dvResultadoAudi">
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <label class="col-md-2 control-label" id="CantidadActual"></label>
                    <div class="col-md-3 text-right">
...
<script type="application/javascript">
    ...
    var Papeleta = {
        AuditorEscogido:function(Audi){
			if(Audi.val() == -1){
				$('#dvResultadoAudi').hide('slow',function(){
