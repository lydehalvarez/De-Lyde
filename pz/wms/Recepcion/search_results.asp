...
var sSQL1  =	"SELECT t.TA_Folio , c.Cli_Nombre , t.TA_Guia , "
 sSQL1 +=" p.Pro_Nombre , p.Pro_SKU ,t.TA_FechaElaboracion , t.TA_UbicacionTienda "
 sSQL1 +=" , t.TA_End_Warehouse , e51.Cat_Nombre , --, e52.Cat_Nombre "
 ...
 sSQL1 +="inner join  Producto p  on a.Pro_ID = p.Pro_ID "
 ...
 sSQL1 +="OR  p.Pro_Nombre  LIKE '%" + buscar +"%' OR p.Pro_SKU = '" + buscar +"' OR a.TAA_SKU = '" + buscar +"' "
  sSQL1 +="OR t.TA_End_Warehouse LIKE '%" + buscar +"%' OR "
 sSQL1 +="TA_CodigoIdentificador  LIKE '%" + buscar +"%' OR t.TA_UbicacionTienda  LIKE '%" + buscar +"%' "
  sSQL1 +="OR t.TA_FechaElaboracion = '" + buscar +"' OR t.TA_Guia = '" + buscar +"' "
 sSQL1 +="OR t.TA_Transportista  LIKE '%" + buscar +"%' OR a.TAA_Cantidad = '" + buscar +"' OR  c.Cli_Nombre LIKE '%" + buscar +"%' "
 sSQL1 +="group by t.TA_Folio, c.Cli_Nombre, t.TA_Guia,  p.Pro_Nombre, p.Pro_SKU, t.TA_End_Warehouse,  t.TA_FechaElaboracion, t.TA_UbicacionTienda "
