...
%>
 <a data-ocid= "<%=OC_ID%>"  
     data-cliid= "<%=Cli_ID%>" 
     data-provid= "<%=Prov_ID%>" 
     data-cliocid= "<%=CliOC_ID%>" 
     data-irid= "<%=IR_ID%>" 
     data-client="<%=CliEnt_ID%>"  
 class="text-muted btnClasificar"><i class="fa fa-inbox"></i>&nbsp;<strong>Regresar a clasificacion de Pallets</strong></a> <br />
