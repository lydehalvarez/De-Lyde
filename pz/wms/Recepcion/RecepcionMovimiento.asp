							...
							<div class="table-responsive">
								...
								<table class="table shoping-cart-table">
									<tbody>
										<tr>
											<td class="desc">
												<input class="btn btn-info btnIngresar" id="btnIngresar" type="button" value="Nuevo movimiento">
											</td>
											</tr>
									</tbody>
								</table>
...
sSQL += " WHERE CAST(ProM_FechaRegistro as DATE) = CAST(getdate() as DATE)  AND c.Sec_ID  = 170"
...
$(document).ready(function() {
	...
	$('.btnEscaneo').click(function(e) {
		...
		$("#Contenido").load("/pz/wms/Recepcion/Recepcion_Escaneo_RFID.asp" + Params)
	});
...
function RecepImprime(folio){
	var newWin=window.open("http://wms.lyde.com.mx/pz/wms/Recepcion/RecepcionMovImpreso.asp?Folio="+folio);
}
	...
	$('.btnEliminar').click(function(e) {
		...
		$("#Contenido").load("/pz/wms/Recepcion/RecepcionMovimiento.asp")
			sTipo = "info";
