							...
							<div class="table-responsive">
								...
								<table class="table shoping-cart-table">
									<tbody>
										<tr>
											<td class="desc">
												<input class="btn btn-info btnIngresar" id="btnIngresar" type="button" value="Nuevo folio">
											</td>
											</tr>
									</tbody>
								</table>
...
sSQL += "WHERE ProM_FechaRegistro = getdate() AND c.Sec_ID  = 170"
      ...
      <div class="modal-body">
        <div class="form-horizontal">
             <div class="form-group">
               ...
               <label class="control-label col-md-3"><strong>Etiqueta</strong></label>
<!--                
...
-->                
	   ...
	   <%
                            var sEventos = "class='form-control'"
                                ...
                                ComboSeccion("CboEstatus", sEventos, 170, -1, 0, "", "", "Editar")
...
$(document).ready(function() {
	...
	$('.btnEscaneo').click(function(e) {
		e.preventDefault()
		var Params = "?ProM_ID=" + $(this).data("promid") 
		//	Params += "&Cli_ID=" + $(this).data("cliid") 
			Params += "&Pro_ID=" + $(this).data("proid") 
	
		$("#Contenido").load("/pz/wms/Recepcion/Recepcion_EscaneoRFID.asp" + Params)
	});
		...
		datoAgenda['CboEstatus'] = $('#CboEstatus').val()	
...
function RecepImprime(folio){
	var newWin=window.open("http://wms.lyde.com.mx/pz/wms/Recepcion/RecepcionFolioMovImpreso.asp?Folio="+folio);
}
	...
	$('.btnEliminar').click(function(e) {
		...
		datoAgenda['Tarea'] = 5
		$("#dvMovimiento").load("/pz/wms/Recepcion/RecepcionMovimiento_Ajax.asp",datoAgenda)
	...
	var params = "?CliOC_ID=" + $('#CliOC_ID').val()
		...
		$("#Contenido").load("/pz/wms/Recepcion/RecepcionMovimiento.asp" + params)
			sTipo = "info";
...
function GuardaMovimiento(Evento){
			$("#dvMovimiento").load("/pz/wms/Recepcion/RecepcionMovimiento_Ajax.asp",Evento
...
function UpdateCita(id){
	$.post("/pz/wms/Recepcion/RecepcionMovimiento_Ajax.asp",{
		Tarea:3
		,IR_ID:id
...
$('#cboProducto').change(function(e) {
        e.preventDefault()
		$.get("/pz/wms/Recepcion/RecepcionMovimiento_Ajax.asp",{
			Tarea:2
			,Pro_SKU:$(this).val()
		}, function(data){
			if (data != "") {
