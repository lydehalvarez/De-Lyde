...
<%
	...
	var sSQLRec = "SELECT COUNT(*) as Citas "
		...
		sSQLRec += " WHERE IR_EstatusCG52 = 1  AND cast(IR_FechaEntrega as date)  = '"  + f2 + "'"
...
<%if((IDUsuario == 97) || (IDUsuario == 34) || (IDUsuario == 36)) {%>
                                ...
                                <tr>
								  ...
								  <%  }  %>
                                    ...
                                    <td class="desc" style="width: 30%;">
                                        ...
                                        <div class="m-t-sm">
                                            <a <%=Llaves%>
											   class="text-muted btnRecibir"><i class="fa fa-inbox"></i>&nbsp;<strong>Recibir</strong></a> <br />
                                            <a  data-ocid="<%=OC_ID%>" data-cliocid="<%=CliOC_ID%>"  data-cliid="<%=Cli_ID%>" class="text-muted btnHuella"><i class="fa fa-inbox"></i>&nbsp;<strong>Incidencias </strong></a> <br />
                                            <a data-ocid="<%=OC_ID%>"  data-provid="<%=Prov_ID%>" data-cliocid="<%=CliOC_ID%>"  data-cliid="<%=Cli_ID%>"  data-irid="<%=IR_ID%>" class="text-muted btnImprimeRecep"><i class="fa fa-print"></i>&nbsp;<strong>Imprimir</strong></a>
                                        </div>
                                    </td>
                                    <td class="desc">
                  <% if(IR_Conductor !=""){ %>
