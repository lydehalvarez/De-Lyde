...
var sSQL = "SELECT top(10) s.IR_ID, s.IR_Folio, s.CliOC_ID, s.Cli_ID, s.OC_ID, s.Prov_ID "
         + " FROM Inventario_Recepcion s  "
         + " INNER JOIN Recepcion_Pallet p "
         + " ON p.IR_ID= s.IR_ID "
         + " LEFT JOIN Recepcion_Series r "
         + " ON r.Pt_ID=p.Pt_ID "
         + " WHERE IR_EstatusCG52 <> 21 "
            ...
            <div class="ibox">
                ...
                <br />
                     ...
                     <div class="input-group date">
                        ...
                        <a href="#" class="btn btn-danger btn-sm BuscarCita"><i class="fa fa-calendar"></i>&nbsp;&nbsp;Buscar</a>
