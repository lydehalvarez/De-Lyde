...
var Pro_PesoNetoPt = 0
   	...
   	var sSQL1  = "select  p.Pro_ID, p.Pro_Nombre from inventario_recepcion r "
	     ...
	     sSQL1 += "inner join Cliente_OrdenCompra t  on  t.CliOC_ID = r.CliOC_ID AND  t.Cli_ID = r.Cli_ID "
		 sSQL1 += "inner join  Cliente_OrdenCompra_Articulos a  on t.CliOC_ID = a.CliOC_ID AND  t.Cli_ID =a.Cli_ID "
	     sSQL1 += "inner join  Producto p  on a.Pro_ID = p.Pro_ID where r.Cli_ID = " + Cli_ID +" and r.CliOC_ID = " + CliOC_ID 
