        ...
        <div class="col-md-9">
            <div class="ibox">
                <div class="ibox-title">
                    <span class="pull-right"> <a  href='pz/wms/Recepcion/RecepcionDocImpreso2.asp?Tipo=3&IR_ID=41' data-irid="<%=IR_ID%>" data-folio="<%=IR_Folio%>" class="text-muted btnImprimeRecep"><i class="fa fa-print"></i>&nbsp;<strong>Imprimir entregas de hoy</strong></a>&nbsp;|&nbsp;(<strong><%=NumCitas%></strong>) Citas</span>
...
<%*/%>                                            <input type="button" value="Recibir"  id="Recibir" class="btn btn-info Recibir"/>
