...
var sSQL = "SELECT c.Prov_ID, a.Pro_ID, c.OC_Folio, a.OCP_SKU, OCP_Cantidad as articulos, Prov_Nombre FROM Proveedor_OrdenCompra c INNER"
	sSQL += " JOIN  Proveedor_OrdenCompra_Articulos  a ON c.OC_ID = a.OC_ID AND c.Prov_ID=c.Prov_ID  inner join proveedor p on  p.Prov_ID=c.Prov_ID"
...
var sSQLTr  = "SELECT count(*) as pallet FROM Recepcion_Pallet WHERE "
if(CliOC_ID > -1){
            ...
            <div class="ibox float-e-margins">
               <div class="ibox-content">
                    <div class="form-group">
                        <legend class="control-label col-md-12" style="text-align: left;"><h1><%=Folio%></h1></legend> 
                <!--    <div class="col-md-3">
                            ...
                            <table class="table shoping-cart-table">
                                ...
                                <tr>
                                    <td class="desc">
                                        ...
                                        <p class="small" id="SeriePickeada"></p>
                                        <% if(Linea==0){%>
                                        <input type="button" value="Ingresar pallet"  id="btnIngresar" class="btn btn-info btnIngresar"/>
<%}%>
                                   </td>
                                    <td class="desc">
                                    <h3>Articulos por clasificar</h3>
                                    <%=Cantidad_Art%>		
                                        
                                    </td>
                                    <td class="desc">
                                    <h3>Cantidad de pallets</h3>
    ...
    <tbody>	
		<%
			...
			sSQL += "p.Pt_Color, p.Pt_Cantidad, p.Pt_LPN, p.Pt_LPNCliente  FROM  Recepcion_Pallet p  INNER JOIN Producto a ON a.Pro_SKU=p.Pt_SKU"			
			sSQL += " WHERE IR_ID="+IR_ID+" AND Pt_PalletEscaneado = 0 AND p.Cli_ID ="+Cli_ID+" AND p.CliOC_ID= "+CliOC_ID
			}
				  if(OC_ID > -1){
			   	sSQL = "SELECT a.Pro_ID, p.Pt_ID, p.CliOC_ID, p.TA_ID, p.Cli_ID, p.OC_ID, p.Prov_ID, p.Pt_SKU, p.Pt_Modelo,"
				...
				sSQL += "  IR_ID="+IR_ID+"  AND Pt_PalletEscaneado = 0 AND p.Prov_ID="+Prov_ID+" AND p.OC_ID= "+OC_ID
			} 
				if(Linea>0){
...
-->                
            ...
            <div class="form-group">
             ...
             <div class="form-group">
                ...
                <label class="control-label col-md-3"><strong>LPN</strong></label>
                <div class="col-md-3">
...
-->                
                ...
                <label class="control-label col-md-3"><strong>Linea</strong></label>
                <div class="col-md-3">
                    <select id="Pt_Linea" class="form-control agenda">
...
-->                
             ...
             <div class="form-group">
                <label class="control-label col-md-3"><strong>Cantidad Masterbox</strong></label>
                <div class="col-md-3">
                    <input class="form-control agenda" id="CliEnt_CantidadArticulos" placeholder="" min="1" type="number" autocomplete="off" value="1"/> 
                </div>
                <label class="control-label col-md-3"><strong>Cama Pallet</strong></label>
                <div class="col-md-3">
                    <input class="form-control agenda" id="CamaPallet" placeholder="" type="number" min="1" autocomplete="off" value="1"/> 
                </div>
            </div>
             <div class="form-group">
               <label class="control-label col-md-3"><strong>Filas Pallet</strong></label>
               <div class="col-md-3">
                   <input class="form-control agenda" id="FilasPallet" placeholder="" type="number" min="1" autocomplete="off" value="1"/> 
               </div>
            </div>
        </div>   
      </div>
