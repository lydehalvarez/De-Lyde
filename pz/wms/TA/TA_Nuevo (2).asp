...
// HA ID: 3 2020-JUL-16 Agregado de Eliminación y folio
// HA ID: 4 2020-AGO-07 Cambio de Almacenes de ORIGEN y DESTINO 
...
switch( parseInt(intIdSis) ){
	//LYDE
	case cIntIdSisLyde:{
		intRedVenFic = 2529 //Menú de ficha
		intRedVenBus = 2520	//Menú Buscar
	} break;
	//IZZI
	case cIntIdSisIzzi:{
		intRedVenFic = 1112 //Menú de ficha
		intRedVenBus = 1100	//Menú Buscar
	} break;
}
...
%>
	...
	<!-- Select2 -->
	<script src="<%= strRutaBaseTem %>js/plugins/sheetJs/xlsx.full.min.js"></script>
	...
	<script type="text/javascript">
		...
		var intRedVenFic = <%= intRedVenFic %>;
		var intRedVenBus = <%= intRedVenBus %>;
	...
	<div class="row" id="ContenedorTransferencia">
		<div class="col-sm-8">
			<div class="ibox ">
											...
											<div class="col-md-12 forum-item active">
												<div class="pull-right">
													<div class="tooltip-demo">
														<button type="button" class="btn btn-success btn-seg" onclick="Transferencia.ActivarSeccion(Transferencia.Seccion.Destino)">
...
%>
												...
												<div class="form-group col-md-12 row">
													<label for="selCliente" class="col-form-label col-md-3">
														Cliente
													</label>
													<div class="col-md-4">
														<select id="selCliente" class="form-control" onChange="Cliente.Seleccionar();">
...
%>												
												...
												<div class="form-group col-md-12 row">
													<label for="inpFechaEntrega" class="col-form-label col-md-3">
														Fecha de Entrega
													</label>
                                                ...
                                                <% //HA ID: 3 INI Se agrega Codigo identificador
												%>
                                                
                                                <div class="form-group col-md-12 row border-bottom">
													<label class="col-form-label col-md-12 p-3">
														<i class="fa fa-id-card-o"></i> Identificadores
													</label>
												</div>
                                                
                                                <div class="form-group col-md-12 row">
													<label for="inpCodigoIdentificador" class="col-form-label col-md-3">
														C&oacute;digo Identificador
													</label>
													<div class="input-group col-md-4">
														<input type="text" id="inpCodigoIdentificador" class="form-control" maxlength="20" 
                                                         placeholder="C&oacute;digo Identificador" autocomplete="off">
													</div>
												</div>

												<div class="form-group col-md-12 row">
													<label for="inpFacturaCliente" class="col-form-label col-md-3">
														Factura Cliente
													</label>
													<div class="input-group col-md-4">
														<input type="text" id="inpFacturaCliente" class="form-control" maxlength="20" 
                                                         placeholder="Factura Cliente" autocomplete="off">
													</div>
												</div>
									...
									<div class="ibox-content" style="padding-top: 2px; padding-bottom: 198px;">
										<div class="ibox">
											<div class="col-md-12 forum-item active">
												...
												<div class="pull-right">
													<div class="tooltip-demo">
														<button type="button" class="btn btn-success btn-seg" onclick="Transferencia.VisualizarSeccion(Transferencia.Seccion.Tipo)">
															<i class="fa fa-chevron-left" style="color: white;"></i> Anterior
														</button>
														<button type="button" class="btn btn-success btn-seg" onclick="Transferencia.ActivarSeccion(Transferencia.Seccion.Articulo)">
															Siguiente <i class="fa fa-chevron-right" style="color: white;"></i>
														</button>
													</div>
												</div>
												...
												<div class="form-group col-md-12 row">
													...
													<div class="col-md-4 classOrigen">
														<select id="selOrigenAlmacen" class="form-control" style="width: 220px;" 
														 onChange="Almacen.Seleccionar(Almacen.Movimiento.Origen);">
													...
													<div class="col-md-4 classDestino">
														<select id="selDestinoAlmacen" class="form-control" style="width: 220px;"
														 onChange="Almacen.Seleccionar(Almacen.Movimiento.Destino);">
									...
									<div class="ibox-content" style="padding-top: 2px; padding-bottom: 198px;">
										<div class="ibox">
											<div class="col-md-12 forum-item active">
												...
												<div class="pull-right">
													<div class="tooltip-demo">
                                                    	<% //HA ID: 3 Se agrega Boton de Eliminación de Transferencia
														%>
                                                        <button type="button" class="btn btn-danger btn-seg" onclick="Transferencia.Eliminar()">
															<i class="fa fa-times" style="color: white;"></i> Eliminar
														</button>
                                                        
														<button type="button" class="btn btn-success btn-seg" onclick="Transferencia.VisualizarSeccion(Transferencia.Seccion.Destino)">
															<i class="fa fa-chevron-left" style="color: white;"></i> Anterior
														</button>
														<button type="button" class="btn btn-success btn-seg" onclick="Transferencia.ActivarSeccion(Transferencia.Seccion.Resumen)">
															Siguiente <i class="fa fa-chevron-right" style="color: white;"></i>
														</button>
													</div>
												</div>
												...
												<div class="form-group col-md-12 row">
													<label class="col-form-label col-md-8 p-6 border-bottom">
														<i class="fa fa-file-text-o fa-lg"></i> Lista de Articulos
														<br>&nbsp;
													</label>
													<div class="col-md-2 text-right" id="divMasivo">
														<button type="button" class="btn btn-info btn-seg" data-toggle="modal" data-target="#modalCargaMasiva">
                                                            Masivo
														</button>
													</div>
													<div class="col-md-2 text-right">
														<button type="button" class="btn btn-success  btn-seg" data-toggle="modal" data-target="#modalBuscaArticulo"
                                                        onclick="Articulo.Cerrar();">
...
-->												
											...
											<div class="col-md-12 forum-item active">
												...
												<div class="pull-right">
													<div class="tooltip-demo">
														...
														<button type="button" class="btn btn-success btn-seg" onclick="Transferencia.VisualizarSeccion(Transferencia.Seccion.Articulo)">
															<i class="fa fa-chevron-left" style="color: white;"></i> Anterior
														</button>
														<button type="button" class="btn btn-success btn-seg" onclick="Transferencia.ActivarSeccion(Transferencia.Seccion.Terminar)">
                                                ...
                                                <div class="form-group col-md-12 row">
													<span class="col-form-label col-md-4">
														<i class="fa fa-id-card-o"></i> C&oacute;digo Identificador
													</span>
													<label id="lblResCodigoIdentificador" class="col-form-label col-md-8 text-success">
										...
										<div class="ibox-content" style="padding-top: 2px; padding-bottom: 198px;">
											<div class="ibox col">
												<div class="col-md-12 forum-item active">
													...
													<div class="pull-right">
														<div class="tooltip-demo">
															<button type="button" class="btn btn-success btn-seg" 
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="form-group row">
						<div class="form-group col-md-12 row">
							...
							<div class="col-md-2 text-right">
								<button type="button" class="btn btn-success btn-seg" onclick="Articulo.Buscar();">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-secondary btn-seg" data-dismiss="modal" onclick="Articulo.Cerrar();">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<button type="button" class="close btn-seg" data-dismiss="modal" aria-label="Close">
						<span aria-hidden="true">&times;</span>
					</button>
				</div>
				<div class="modal-body">
					<div class="form-group row">
						<div class="form-group col-md-12 row">
							...
							<div class="col-md-2 text-right">
								<button type="button" class="btn btn-success btn-seg" onclick="Serie.Buscar();">
									<i class="fa fa-search" style="color: white;"></i> Buscar
								</button>
							</div>
						</div>
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-secondary btn-seg" data-dismiss="modal" onclick="Serie.Cerrar();">
						<i class="fa fa-times"></i> Cerrar
					</button>
				</div>
			</div>
    ...
    <% //HA ID: 2 FIN
	%>
	<div class="modal fade" id="modalCargaMasiva" tabindex="-1" role="dialog" aria-labelledby="divmodalCargaMasiva" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<h2 class="modal-title" id="divModalBuscaArticulo">
                    	<i class="fa fa-search"></i> Carga masiva
                        <br />
                        <small>Carga de manera masiva todas la series que le pertenecen a la transferencia</small>
                    </h2>
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
						<span aria-hidden="true">&times;</span>
					</button>
				...
				<div class="modal-body">
                    <div class="form-horizontal">
                        <div class="form-group">
                            <label class="from-control col-md-6">Layout de carga masiva</label>
                            <input type="button" class="btn btn-success" onclick="TipoDeCargas.LayoutMasivo()" value="Descarga el layout"/>
                        </div>
                        <div class="form-group" id="divArchivo">
                            <label class="from-control col-md-6">Selecciona el archivo de carga</label>
                            <input class="fileinput fileinput-new" type="file" id="fileUploader" name="fileUploader" accept=".xls, .xlsx"/>
                        </div>
                        <div class="form-group text-center" id="divLoading">
                            <div class="spiner-example">
                                <div class="sk-spinner sk-spinner-rotating-plane"></div>
                            </div>
                            <div>Cargando datos del excel espere por favor...</div>
                         </div>
                        <div class="form-group text-center" id="divVerifica">
                            <input class="btn btn-info btnVerifica" type="button" value="Verificar el excel"/>
                        </div>
                        <div id="divGeneralResumen">
                            <div class="table-responsive text-center" id="divResumen">
                                <div>
                                    <table class="table table-bordered">
                                        <thead>
                                            <th colspan="4"  style="text-align: center;">Resumen de lo solicitado</th>
                                        </thead>
                                        <thead>
                                            <tr>
                                                <th>SKU</th>
                                        ...
                                        <tbody id="tableResumenSolicitado"></tbody>
                                    </table>
                                </div>
                                <div>
                                    <table class="table table-bordered">
                                        <thead>
                                            <tr>
                                                <th colspan="4"  style="text-align: center;">Resumen del archivo</th>
                                            </tr>
                                        </thead>
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody id="tableResumenArchivo"></tbody>
                                    </table>
                                </div>
                            </div>
                            <div><small>Nota* Si existe producto no solicitado en el archivo este archivo no funcionar&aacute;.</small></div>
                        </div>
                    </div>
                    <input type="hidden" id="ID_Masivo" name="ID_Masivo"/>
				</div>
				<div class="modal-footer">
					<button type="button" class="btn btn-secondary btn-seg" data-dismiss="modal">
						<i class="fa fa-times"></i> Cerrar
					</button>
					<button type="button" class="btn btn-success btnTerminar btn-seg" disabled>
