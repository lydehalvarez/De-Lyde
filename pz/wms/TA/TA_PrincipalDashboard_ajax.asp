        ...
        <div class="col-sm-2">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <div class="stat-percent font-bold text-success">
                        <%= formato( (intTotCanceladas * 100) / intTotRecibidas, 1) %>%
                    </div>
                ...
                <div class="ibox-content">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="stat-percent font-bold text-success">
                                <%= formato( (intTotPicking * 100) / intTotRecibidas, 1) %>%
                            </div>
                            <small>Picking</small>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="stat-percent font-bold text-success">
                                <%= formato( (intTotPacking * 100) / intTotRecibidas, 1) %>%
                            </div>
                            <small>Packing</small>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="stat-percent font-bold text-success">
                                <%= formato( (intTotShiping * 100) / intTotRecibidas, 1) %>%
                            </div>
                            <small>Shiping</small>
                        </div>
        ...
        <div class="col-sm-2">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <div class="stat-percent font-bold text-success">
                        <%= formato( (intTotTransito * 100) / intTotRecibidas, 1) %>%
                    </div>
        ...
        <div class="col-sm-2">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <div class="stat-percent font-bold text-success">
                        <%= formato( (intTotEntregadas * 100) / intTotRecibidas, 1) %>%
                    </div>
...
<%
    ...
    case 2: {
        ...
        while( !(rsEmpaque.EOF) ){
            ...
            arrPendientes.push( rsEmpaque("Pendiente").Value )
                ...
                + '"lineData": {'
                    ...
                    + ', "datasets": [' 
                          + '{'
                            ...
                            + ', "borderColor": "rgba(175,122,197,0.7)" '
                            + ', "pointBackgroundColor": "rgba(175,122,197,1)" '
                            + ', "pointBorderColor": "#fff" '
                            + ', "fill": false '
                            + ', "data": [' + arrPendientes.join(",") + '] '
                        + '}'
                        + ', {'
                            + '"label": "Picking" '
