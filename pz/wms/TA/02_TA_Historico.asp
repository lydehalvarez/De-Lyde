...
<div class="ibox float-e-margins">
        <div class="ibox-title">
          <h5><i class="fa fa-cube"></i> Cajas</h5>
        </div>
      ...
      <table class="table table-hover no-margins">
         ...
         <tbody>
            <%
               ...
               var sSQLCaja = "SELECT TAC_ID,TAC_Codigo,CONVERT(NVARCHAR(10),TAC_FechaRayosX,103) +' - ' + CONVERT(NVARCHAR(10),TAC_FechaRayosX,108)+' hrs' Fecha "
				...
				%>                
                <tr>
                    <td><small><strong><%=TAC_ID%></strong></small></td>
                    <td><small><%=TAC_ID%></small></td>
                    <td><small><%=TAC_FechaRayosX%></small></td>
                </tr>      
				<%
					rsBox.MoveNext() 
                }
