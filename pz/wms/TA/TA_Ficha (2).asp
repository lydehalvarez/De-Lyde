...
<% 
			...
			if(TAF_FolioEntrada != ""){
%>
											  <input type="button" value="Nota de entrada" data-titulo="entrada"  data-tipo="4" data-folio="<%=TAF_FolioEntrada%>" class="btn btn-success btnRecuperaDoc"/>
<%
			}										 
...
%>
                                    <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#ModalEvento">
		...
		if(Parametro("TA_EsRecibido",-1) == 0 ){
            ...
            //si esta cancelado no se puede dar por recibido 
            if(Parametro("TA_EstatusCG51",0) == 11){
				   	bPasa = false
            }  
