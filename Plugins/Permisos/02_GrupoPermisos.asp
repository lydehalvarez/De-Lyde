...
var sElemento = ""
	...
	var CCSQL = "Select Mnu_ID, Mnu_Titulo FROM Menu "
		CCSQL += " Where Mnu_Padre = 30 and Mnu_EsMenu = 1 and Sys_ID = " + SistemaActual
...
//	sG += "</td></tr>"
	...
	sG += "<input type=" + sC + "hidden" + sC + " name=" + sC + "Gru_ID" + sC + " id=" + sC + "Gru_ID" + sC + " value=" + sC + GruID + sC + ">"
	...
	sG += " $('#BSpanel1').html('Grupo: <strong>' + $('#NombreGrupo').val() + '</strong>'); "
	sG += "</script>"
