...
var MnuID  = Parametro("MnuID",-1)
var Mnu_ID  = Parametro("Mnu_ID",-1)
var Seg_ID  = Parametro("Seg_ID",-1)
var UsuConGpo = Parametro("UsuConGpo",0)
var iqCli_ID = Parametro("iqCli_ID",19)
var TipoPermiso = Parametro("TipoPermiso",-1)
var SistemaATrabajar = Parametro("SistemaATrabajar",19)
//var SistemaActual = Parametro("SistemaActual",19)
...
<%
		...
		case 4:  // un usuario abandona un grupo
			...
			//try {
				...
				var sCondicion = ""
				var TablaUsuario = ParametroDeVentana(SistemaActual, MnuID, "Tabla Usuario", "Usuario")
				var LlaveBase = ParametroDeVentana(SistemaActual, MnuID, "Llave base", "")
				...
				var LlaveGrupo = ParametroDeVentana(SistemaActual, MnuID, "Llave del grupo", "")
				var ValorLlaveGrupo = -1
				if(LlaveGrupo != "" ) {
					ValorLlaveGrupo = Parametro(LlaveGrupo,-1)
				}
				var LlaveUsuario = ParametroDeVentana(SistemaActual, MnuID, "Llave del usuario", "")
