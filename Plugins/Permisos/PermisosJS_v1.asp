...
function GuardaValores(iIDSeguridad ,iEsFuncion ,iValorPermiso ,bChecado ,iAvisa, iUsuariosaliendoGrupo) {
	...
	if (iUsuariosaliendoGrupo == 1) {
		//$("#dvError").html('/Plugins/Permisos/Permisos_v1_Ajax.asp?Tarea=4&Gru_ID=' + $("#sGru_ID").val() + '&Usu_ID=' + $("#Usu_ID").val() + '&iqCli_ID=' + $("#iqCli_ID").val() );
...
//		$("#dvError").html("/Plugins/Permisos/Permisos_v1_Ajax.asp?" + sData );
...
function LlenaConPermisos(IDMenu) {
	...
	$.post("/Plugins/Permisos/Permisos_v1_Ajax.asp", { Tarea:1,Gru_ID:$("#sGru_ID").val(),Usu_ID:$("#sUsu_ID").val()
	                                                ,SistemaATrabajar:$("#SistemaATrabajar").val()
													,iqCli_ID:$("#iqCli_ID").val()
													,SistemaActual:$("#SistemaActual").val()
