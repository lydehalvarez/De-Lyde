...
function CargaDatos() {
	...
	//comienza tabla de secciones  
		sResultado = "<table width=" + sC + "100%" + sC + " border=" + sC + "0" + sC + " align=" + sC + "left" + sC + " cellpadding=" + sC + "0" + sC + " cellspacing=" + sC + "0" + sC  + ">"
...
//***************************************************************************************************************
			...
			var iControl = 1
				...
				sResultado += "<table width=" + sC + "100%" + sC + " border=" + sC + "1" + sC + " cellpadding=" + sC + "0" + sC + " cellspacing=" + sC + "0" + sC + ">"
				...
				while (!rsCampos.EOF){  //Juego de Campos
					...
					if (iRen < rsCampos.Fields.Item("MFC_Renglon").Value) {
						...
						//resetear iCol = 1
						iCol = 1						
						for (iCF=iRen;iCF<rsCampos.Fields.Item("MFC_Renglon").Value;iCF++) {
							//cerrar renglon,
							sResultado += "</tr>"
							//abrir nuevo renglon
							sResultado += "<tr class=" + sC + "FichaCampoValor" + sC + ">"
