	...
	//comienza tabla de secciones  
		...
		while (!rsSeccion.EOF){
			...
			var iColPorSecRegOriginal = iColPorSecReg
				...
				sResultado += "<table width=" + sC + "100%" + sC + " border=" + sC + "0" + sC + " cellpadding=" + sC + "0" + sC + " cellspacing=" + sC + "0" + sC + ">"
					...
					//********* Armado de Objetos *****************
						...
						switch (parseInt(rsCampos.Fields.Item("MFC_TipoCampo").Value)) {
									...
									case 3:						//			3 = combo de cualquier tabla					
										...
										if (!EsVacio(rsCampos.Fields.Item("MFC_EventosJS").Value)) {
											...
											sCampo = "&nbsp;" + CargaComboFicha(sNombreCampo,Eventos,sCampoLlave,
																...
																sOrden,ValorDelCampo,0,"Seleccione una opción",sModoRO)
										break;
									case 4:  // 4 = combo
									...
									case 14:	//		14 = 	solo imprime un parametro								
										...
										break;
									case 15:	//		15 = 	Fecha en texto y su campo juliano solo para TCE
										if (sModoRO == "Editar") {
											sCampo = "<script type=" + sC + "text/javascript" + sC + ">"
												sCampo += "	$(function() {"
													sCampo += "	$( " + sC +	"#" + sNombreCampo + sC + " ).datepicker({"
...
var sSQLConfBase = " select MW_Param, MW_PuedeAgregar, MW_PuedeBorrar, MW_PuedeEditar "
	...
	sSQLConfBase += " AND Wgt_ID = 26 "  // + iWgID
...
//formato
//1 = $ simbol de pesos antes
//2 = , coma centecimal y dos decimales ejemplo 1,234.56
//3 = % porcentaje
//4 = si/no
//5 = formato fecha de CST a dd/mm/yyyy
//6 = 
//
//tipo de dato
//1 = textbox
//2 = option   bolitas de check usa campo de MFC_arrValores para los valores ejemplo 1,2|si,no
//3 = combo a partir de una tabla usando los campos 
//              MFC_ComboCampoDesc
//			  MFC_ComboTabla
//			  MFC_ComboCondicion
//			  MFC_Class
//			  MFC_EventosJS
//4 = obsoleto
//5 = check box    MFC_Class
//6 = fecha modo texto formato dd/mm/yy
//7 = combo catalogo general 
//             MFC_EventosJS
//			 MFC_ComboCampoDesc
//			 MFC_ComboCondicion
//			 MFC_Orden
//			 MFC_LeyendaSelecTodos
//			 MFC_IDCatalogoGeneral
//8 = textbox password
//9 = Text Area
//10 = Sí / no
//11 = obsoleto
//12 = 	Hacer un div
//13 =    Una subconsulta	solo consulta
//			MFC_Campo
//			MFC_ComboTabla
//			MFC_ComboCondicion
//14 = 	solo imprime un parametro
//15 = 	Fecha en texto y su campo juliano   solo para TCE
%>