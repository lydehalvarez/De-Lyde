...
//Declare @PageSize int = 150
//
//SELECT  RowNumber,Cli_ID, Ven_ID, Cli_DTRFC, Cli_DTPaterno, Cli_DTMaterno, Cli_DTNombres, Cli_DTNomCompleto
//FROM (
//     SELECT *,ROW_NUMBER() OVER (ORDER BY Cli_DTNomCompleto) AS RowNumber 
//     FROM Clientes 
//) AS Tabla
