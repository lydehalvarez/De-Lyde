...
var iIQonDebug      = 0
	...
	var sSQLConfBase = " select Wgt_ID, WgCfg_ID, MW_Param, MW_PuedeAgregar, MW_PuedeBorrar, MW_PuedeEditar, "
		...
		sSQLConfBase += " AND Wgt_ID = 25 "  // + iWgID
		//sSQLConfBase += " AND WgCfg_ID = " + iWgCfg_ID
		

if (iIQonDebug > 0) { 
    Response.Write("<br>linea 105 cargando los datos de menuwidget<br> SQL = " + sSQLConfBase) 
    Response.Write("<br>linea 105 uasuario y " + IDUsuario + " TipoUsuario" + UsuarioTpo + "<br>") 
}
...
if (iIQonDebug > 0) { Response.Write("<br>linea 136 cargando los datos de la tabla<br> SQL = " + sATTb) }
	...
	if (iIQonDebug > 0) { 
		Response.Write("<br>linea 176 <br>") 
	...
	if (iIQonDebug > 0) { Response.Write("<br>linea 125 sql llaves<br>" + sSQLTT) }
	...
	if (iIQonDebug > 0) { Response.Write("<br>linea 134 armado de las llaves<br>") }
//Armado de arreglos de llaves
	...
	if (iIQonDebug > 0) { Response.Write("<br>linea 195 armado de los parametros que envian<br>") }
...
if (iIQonDebug > 0) { Response.Write("<br>linea 230 armado de la condicion<br>") }
...
if (iIQonDebug > 0) { Response.Write("<br>linea 265 armado de los parametros de busqueda<br>") }	
...
if (iIQonDebug > 0) { Response.Write("<br>linea 381 Armado de arreglos de campos<br>") }	
...
function ArmaPaginacion(iPaginas,iRegistros) {
	...
	sPaginacion += "<table class=" + sC + "Paginador" + sC + " width=" + sC + "100%" + sC + " border=" + sC + "0" + sC + " cellpadding=" + sC + "0" + sC + " cellspacing=" + sC + "0" + sC + ">"
	if (iMWPuedeAgregar >= 1 && Session("Agregar") == 1) {
		sPaginacion += "<tr><td colspan=" + sC + "2" + sC + " align=" + sC + "left" + sC + "><div id='dvgrdbotones'></div></td>"
		sPaginacion += "<td colspan=" + sC + "9" + sC + " align=" + sC + "right" + sC + ">"
	...
	sPaginacion += "<tr class=" + sC + "PaginadorAreaBotones" + sC + " >"
	sPaginacion += "<td width=" + sC + "5%" + sC + " align=" + sC + "left" + sC + " valign=" + sC + "middle" + sC + "><img src=" + sC + "/Plugins/Grid_IQon/img/Boton.jpg" + sC + " width=" + sC + "24" + sC + " /></td>"
	sPaginacion += "<td width=" + sC + "71%" + sC + " align=" + sC + "right" + sC + " valign=" + sC + "middle" + sC + "> Registros por p&aacute;gina "
	sPaginacion += "<select style='width:70px' name=" + sC + "RegPorVentana" + sC + " id=" + sC + "RegPorVentana" + sC
...
//	sPaginacion += "<input type=" + sC + "hidden" + sC + " name=" + sC + "AccionDePaginacion" + sC + " value=" + sC + 1 + sC + ">"
	...
	sPaginacion += "<select style='width:70px' name=" + sC + "IrAPagina" + sC + " id=" + sC + "IrAPagina" + sC  
	sPaginacion += " onchange=" + sC + "AcIrAPagina(this.value)" + sC + " >"     
	...
	sPaginacion += "<td width=" + sC + "3%" + sC + " align=" + sC + "right" + sC + " >&nbsp;&nbsp;&nbsp;</td></tr>"
	sPaginacion += "<tr><td height=" + sC + "1" + sC + " colspan=" + sC + "11" + sC + " bgcolor=" + sC + "#000033" + sC + " ></td></tr>"
...
function ArmaEncabezados() {
	...
	var sEncabezado  = "<table width=" + sC + "100%" + sC + " border=" + sC + "0" + sC + " cellspacing=" + sC 
		sEncabezado += "0" + sC + " cellpadding=" + sC + "0" + sC  + " " 
		sEncabezado += " class=" + sC + "TablaGeneral" + sC + "><tr class=" + sC + "TablaEncabezado" + sC + ">"
		sEncabezado += "<tr class=" + sC + "TablaEncabezado" + sC + ">"
		if (MGrdT_TieneChecks==1) {
			sEncabezado += "<td width=" + sC + "20" + sC + " class=" + sC + "TablaEncabezado" + sC + " >"
			sEncabezado += "<input name=\"chkT\" id=\"chkT\" type=\"checkbox\" onclick=\"javascript:CkTd()\" /></td>"
			sEncabezado += "</td>"	
		}
		sEncabezado += "<td width=" + sC + "20" + sC + " class=" + sC + "TablaEncabezado" + sC + " >Num.</td>"
...
//seccion de armado de llaves	
			...
			//pendiente , validar este permiso para que funcione bien
			iMWPuedeSeleccionar=1
			if (iMWPuedeSeleccionar >= 1 && iMW_PuedeSeleccionar >= 1) {
				//if (iAbrirNuevaVentana == 0) {
				
//				var sValoresPrm = ""
				sDatos += "&nbsp;&nbsp;<a href=" + sC + "javascript:grSelecciona("
//				var llt=0
//				for (llt=0;llt<LLaveCampo.length;llt++) {
//					//Response.Write("<br>" + llt + ") " + LLaveCampo[llt])
//					if(LLaveHeredada[llt] == 0) {
