...
<%
	...
	var iIQonDebug = 1 //ParametroDeVentanaConUsuario(SistemaActual, VentanaIndex, IDUsuario, "Debug",0)	
...
if (iIQonDebug == 1) { 
	...
	if (iWgCfg_ID == 0 ) {
		var sConddv = "Wgt_ID = 62 and Sys_ID = " + SistemaActual + " and Mnu_ID = " + VentanaIndex
		iWgCfg_ID = BuscaSoloUnDato("WgCfg_ID","Menu_Widget",sConddv,0,2)
	}

	var iWgt_ID = Parametro("Wgt_ID",62)
...
//   Campo,EsPermanente class='iQon'
	...
	for (t=0;t<LLaveCampo.length;t++) {
		//Response.Write(LLavePP[t]+"<br />")
		if (LLavePP[t] == "No") {
			//Response.Write(LLaveHeredada[t]+"<br />")class='iQon'
