...
function IniciaDebugBD() {
	if (bDebugWidgets) {               
		var sSQL = "Delete from Debug "
			sSQL += "where Sys_ID = " + SistemaActual + " and Mnu_ID = " + VentanaIndex + " and IDUsuario = " + IDUsuario
...
function AgregaDebugBD(sIdentificador,sValor) {
	if (bDebugWidgets) {               
		var sSQL = "Insert into Debug ( Sys_ID, Mnu_ID, IDUsuario, Dbg_Concepto, Dbg_Accion) "
...
var iTipoCampo = -1
	...
	sBDSQLValores = ""
var bInserta = true
//Response.Write("Longitud de campos &nbsp;" + arCamposBD.length)
//
//-----------------------------	DRP 28/07/2003
var bInserta = true
...
if (!bHayParametros || iqCli_ID == -1) {
	//Response.Write("<br> entrada inicial borrando datos y buscando parametros "  )
	//si no hay parametros de ningun tipo y estamos aqui es porque acaba de entrar
...
//Response.Write("<br>VentanaIndex = " + VentanaIndex + " SistemaActual = " + SistemaActual + " iqCli_ID = " + iqCli_ID)
